...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: MotorControll_MainFunction
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Read_Pp_MotorDcBusVoltage_Vbus(float32 *data)
 *   Std_ReturnType Rte_Read_Pp_MotorElectricalAngle_ElectricAngle(float32 *data)
 *   Std_ReturnType Rte_Read_Pp_MotorFaultStatus_tle9180_Ov_Fault(boolean *data)
 *
 * Output Interfaces:
 * ==================
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Write_Pp_MotorCtrlCmd_MotorMode(uint8 data)
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: MotorControll_MainFunction_doc
 *********************************************************************************************************************/
...
FUNC(void, MotorControll_CODE) MotorControll_MainFunction(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: MotorControll_MainFunction
 *********************************************************************************************************************/

  Std_ReturnType fct_status;
  boolean fct_error;

  float32 Read_Pp_MotorDcBusVoltage_Vbus;
  float32 Read_Pp_MotorElectricalAngle_ElectricAngle;
  boolean Read_Pp_MotorFaultStatus_tle9180_Ov_Fault;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  fct_status = TSC_MotorControll_Rte_Read_Pp_MotorDcBusVoltage_Vbus(&Read_Pp_MotorDcBusVoltage_Vbus); /* PRQA S 3226, 0315 */ /* MD_Rte_3226, MD_Rte_0315 */
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = FALSE;
  ...
  fct_status = TSC_MotorControll_Rte_Read_Pp_MotorElectricalAngle_ElectricAngle(&Read_Pp_MotorElectricalAngle_ElectricAngle); /* PRQA S 3226, 0315 */ /* MD_Rte_3226, MD_Rte_0315 */
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = FALSE;
  ...
  fct_status = TSC_MotorControll_Rte_Read_Pp_MotorFaultStatus_tle9180_Ov_Fault(&Read_Pp_MotorFaultStatus_tle9180_Ov_Fault); /* PRQA S 3226, 0315 */ /* MD_Rte_3226, MD_Rte_0315 */
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = FALSE;
  ...
  fct_status = TSC_MotorControll_Rte_Write_Pp_MotorCtrlCmd_MotorMode(Rte_InitValue_Pp_MotorCtrlCmd_MotorMode); /* PRQA S 3226, 0315 */ /* MD_Rte_3226, MD_Rte_0315 */
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = FALSE;
  ...
  fct_status = TSC_MotorControll_Rte_Write_Pp_MotorCurrentRef_Id_Ref(Rte_InitValue_Pp_MotorCurrentRef_Id_Ref); /* PRQA S 3226, 0315 */ /* MD_Rte_3226, MD_Rte_0315 */
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = FALSE;
  ...
  fct_status = TSC_MotorControll_Rte_Write_Pp_MotorCurrentRef_Iq_Ref(Rte_InitValue_Pp_MotorCurrentRef_Iq_Ref); /* PRQA S 3226, 0315 */ /* MD_Rte_3226, MD_Rte_0315 */
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = FALSE;
