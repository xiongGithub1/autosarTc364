...
#ifndef OS_SCHEDULETABLE_LCFG_H
...
extern CONSTP2CONST(Os_SchTConfigType, OS_CONST, OS_CONST) OsCfg_SchTRefs[OS_SCHTID_COUNT + 1];  /* PRQA S 4521 */ /* MD_Os_Rule10.1_4521 */
