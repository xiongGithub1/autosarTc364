...
#define IRQ_GTM_DPLL_SR_CAT        (IRQ_CAT1)
#define IRQ_GTM_DPLL_SR_CAT        (IRQ_CAT1)
#define IRQ_GTM_DPLL_SR_CAT        (IRQ_CAT1)
#define IRQ_GTM_DPLL_SR_CAT        (IRQ_CAT1)
#define IRQ_GTM_DPLL_SR_CAT        (IRQ_CAT1)
...
#define IRQ_GTM_DPLL_SR_PRIO       0x0
#define IRQ_GTM_DPLL_SR_PRIO       0x0
#define IRQ_GTM_DPLL_SR_PRIO       0x0
#define IRQ_GTM_DPLL_SR_PRIO       0x0
#define IRQ_GTM_DPLL_SR_PRIO       0x0
...
#define IRQ_GTM_DPLL_SR_TOS        (IRQ_TOS_CPU0)
#define IRQ_GTM_DPLL_SR_TOS        (IRQ_TOS_CPU0)
#define IRQ_GTM_DPLL_SR_TOS        (IRQ_TOS_CPU0)
#define IRQ_GTM_DPLL_SR_TOS        (IRQ_TOS_CPU0)
#define IRQ_GTM_DPLL_SR_TOS        (IRQ_TOS_CPU0)
...
/* GTM ATOM interrupt Category Setting */

#define IRQ_GTM_ATOM_SR0_CAT        (IRQ_CAT1)
#define IRQ_GTM_ATOM_SR1_CAT        (IRQ_CAT1)
#define IRQ_GTM_ATOM_SR2_CAT        (IRQ_CAT1)
#define IRQ_GTM_ATOM_SR3_CAT        (IRQ_CAT1)

/* GTM ATOM interrupt Priority Setting */
#define IRQ_GTM_ATOM_SR0_PRIO       0x0
#define IRQ_GTM_ATOM_SR1_PRIO       0x0
#define IRQ_GTM_ATOM_SR2_PRIO       0x0
#define IRQ_GTM_ATOM_SR3_PRIO       0x0

/* GTM ATOM interrupt type of service Setting */
#define IRQ_GTM_ATOM_SR0_TOS        (IRQ_TOS_CPU0)
#define IRQ_GTM_ATOM_SR1_TOS        (IRQ_TOS_CPU0)
#define IRQ_GTM_ATOM_SR2_TOS        (IRQ_TOS_CPU0)
#define IRQ_GTM_ATOM_SR3_TOS        (IRQ_TOS_CPU0)
/* GTM ATOM interrupt Category Setting */
