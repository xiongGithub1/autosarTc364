 ...
 *          License:  CBD2200508
 *
 *      Description:  Application types header file for SW-C <DigApp>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_DIGAPP_TYPE_H
# define RTE_DIGAPP_TYPE_H
