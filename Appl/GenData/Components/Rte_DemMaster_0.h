...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemMaster_0_CBReadData_DID_0x1_DID_Data_GlobalTime_ReadData(P2VAR(uint8, AUTOMATIC, RTE_DEMMASTER_0_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
# else
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemMaster_0_CBReadData_DID_0x1_DID_Data_GlobalTime_ReadData(P2VAR(DataArrayType_uint8_6, AUTOMATIC, RTE_DEMMASTER_0_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
# endif
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemMaster_0_CBReadData_PID_0x12_DID_Data_ReadData(P2VAR(DataPrimitiveType_uint16, AUTOMATIC, RTE_DEMMASTER_0_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_DemMaster_0_CBReadData_PID_0x13_DID_Data_ReadData(P2VAR(DataPrimitiveType_uint16, AUTOMATIC, RTE_DEMMASTER_0_APPL_VAR) Data); /* PRQA S 1330, 3451, 0786, 3449, 0624 */ /* MD_Rte_1330, MD_Rte_3451, MD_Rte_0786, MD_Rte_3449, MD_Rte_0624 */
...
#  define Rte_Call_CBReadData_DID_0x1_DID_Data_GlobalTime_ReadData Rte_Call_DemMaster_0_CBReadData_DID_0x1_DID_Data_GlobalTime_ReadData
#  define Rte_Call_CBReadData_PID_0x12_DID_Data_ReadData Rte_Call_DemMaster_0_CBReadData_PID_0x12_DID_Data_ReadData
#  define Rte_Call_CBReadData_PID_0x13_DID_Data_ReadData Rte_Call_DemMaster_0_CBReadData_PID_0x13_DID_Data_ReadData
