...
#endif
#ifndef CANTP_PROCESSOR_TC387Q
#define CANTP_PROCESSOR_TC387Q
#endif
#ifndef CANTP_COMP_TASKING
#define CANTP_COMP_TASKING
#endif
...
/* -----------------------------------------------------------------------------
    &&&~ Rx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_550eef02 0u 
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_aba1e8cc 1u 

 
/* -----------------------------------------------------------------------------
    &&&~ Tx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxNSdu_CanTpTxNSdu_550eef02 0u 


/* -----------------------------------------------------------------------------
    &&&~ Rx Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_2548538f 0u 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_07b2877d     0u 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_a4c851d5     1u 


/* -----------------------------------------------------------------------------
    &&&~ TxConfirmation Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxFcNPdu_CanTpTxFcNPdu_07b2877d 0u 
#define CanTpConf_CanTpTxFcNPdu_CanTpTxFcNPdu_a4c851d5 0u 
#define CanTpConf_CanTpTxNPdu_CanTpTxNPdu_2548538f     0u 
...
#define CANTP_EXISTS_FUNCTIONAL_RXTATYPEOFRXSDUCFG                                                  STD_OFF
#define CANTP_EXISTS_CANFD_PHYSICAL_RXTATYPEOFRXSDUCFG                                              STD_ON
#define CANTP_EXISTS_CANFD_FUNCTIONAL_RXTATYPEOFRXSDUCFG                                            STD_OFF
...
#define CANTP_ISDEF_LOLAYERTXFCPDUIDOFRXSDUCFG                                                      STD_ON
#define CANTP_ISDEF_NAROFRXSDUCFG                                                                   STD_ON
#define CANTP_ISDEF_NBROFRXSDUCFG                                                                   STD_ON
#define CANTP_ISDEF_NCROFRXSDUCFG                                                                   STD_ON
...
#define CANTP_ISDEF_RXTATYPEOFRXSDUCFG                                                              STD_ON
...
#define CANTP_EQ2_LOLAYERTXFCPDUIDOFRXSDUCFG                                                        CanIfConf_CanIfTxPduCfg_msg_diag_Response_MyECU_Tp_oCAN00_59e48f7a_Tx
#define CANTP_EQ2_NAROFRXSDUCFG                                                                     21u
#define CANTP_EQ2_NBROFRXSDUCFG                                                                     21u
#define CANTP_EQ2_NCROFRXSDUCFG                                                                     101u
...
#define CANTP_EQ2_RXTATYPEOFRXSDUCFG                                                                CANTP_PHYSICAL_RXTATYPEOFRXSDUCFG
#define CANTP_EQ2_RXWFTMAXOFRXSDUCFG                                                                15u
#define CANTP_EQ2_STMINOFRXSDUCFG                                                                   20u
...
#define CANTP_EQ2_LOLAYERTXPDUIDOFTXSDUCFG                                                          CanIfConf_CanIfTxPduCfg_msg_diag_Response_MyECU_Tp_oCAN00_59e48f7a_Tx
...
#define CANTP_EQ2_PDURTXSDUIDOFTXSDUCFG                                                             PduRConf_PduRDestPdu_msg_diag_Response_MyECU_oCAN00_45311294_Tx
#define CANTP_EQ2_RXFCADDRESSOFTXSDUCFG                                                             255u
#define CANTP_EQ2_RXFCPDUIDOFTXSDUCFG                                                               CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_2548538f
...
#define CANTP_EQ2_TXPDUCONFIRMATIONPDUIDOFTXSDUCFG                                                  CanTpConf_CanTpTxNPdu_CanTpTxNPdu_2548538f
...
#define CanTp_GetLoLayerTxFcPduIdOfRxSduCfg(Index)                                                  CanIfConf_CanIfTxPduCfg_msg_diag_Response_MyECU_Tp_oCAN00_59e48f7a_Tx
#define CanTp_GetNArOfRxSduCfg(Index)                                                               21u
#define CanTp_GetNBrOfRxSduCfg(Index)                                                               21u
#define CanTp_GetNCrOfRxSduCfg(Index)                                                               101u
...
#define CanTp_GetRxTaTypeOfRxSduCfg(Index)                                                          CANTP_PHYSICAL_RXTATYPEOFRXSDUCFG
#define CanTp_GetRxWftMaxOfRxSduCfg(Index)                                                          15u
#define CanTp_GetSTminOfRxSduCfg(Index)                                                             20u
...
#define CanTp_GetLoLayerTxPduIdOfTxSduCfg(Index)                                                    CanIfConf_CanIfTxPduCfg_msg_diag_Response_MyECU_Tp_oCAN00_59e48f7a_Tx
...
#define CanTp_GetPduRTxSduIdOfTxSduCfg(Index)                                                       PduRConf_PduRDestPdu_msg_diag_Response_MyECU_oCAN00_45311294_Tx
#define CanTp_GetRxFcAddressOfTxSduCfg(Index)                                                       255u
#define CanTp_GetRxFcPduIdOfTxSduCfg(Index)                                                         CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_2548538f
...
#define CanTp_GetTxPduConfirmationPduIdOfTxSduCfg(Index)                                            CanTpConf_CanTpTxNPdu_CanTpTxNPdu_2548538f
