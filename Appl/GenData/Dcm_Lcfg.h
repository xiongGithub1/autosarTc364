...
# define DCM_LCFG_MAJOR_VERSION                                                17u
 ...
 *********************************************************************************************************************/
# define Dcm_ModeOnComControlModeChange(channelId, mode)                       ((void)(Rte_Switch_DcmCommunicationControl_ComMConf_ComMChannel_CN_CAN00_5e566ad9_DcmCommunicationControl_ComMConf_ComMChannel_CN_CAN00_5e566ad9(mode))) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
# define Dcm_CfgWrapStatePreconditions(index)                                  (Dcm_CfgStatePreconditions[(index)])                                  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
# define Dcm_CfgWrapDidMgrDidOpClassInfo(index)                                (&Dcm_CfgDidMgrDidOpClassInfo[(index)])                               /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
# define Dcm_CfgWrapDidMgrSignalOpClassInfo(index)                             (&Dcm_CfgDidMgrSignalOpClassInfo[(index)])                            /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
# define Dcm_CfgWrapDidMgrOpInfoIoControl(index)                               (Dcm_CfgDidMgrOpInfoIoControl[(index)])                               /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
# define Dcm_CfgWrapDidMgrOpInfoCombined(index)                                (Dcm_CfgDidMgrOpInfoCombined[(index)])                                /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
# define Dcm_CfgWrapSvc28SubFuncInfo(index)                                    (&Dcm_CfgSvc28SubFuncInfo[(index)])                                   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
# define Dcm_CfgWrapSvc28SubNetIdMap(index)                                    (Dcm_CfgSvc28SubNetIdMap[(index)])                                    /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
# define Dcm_CfgWrapSvc85SubFuncInfo(index)                                    (&Dcm_CfgSvc85SubFuncInfo[(index)])                                   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
typedef P2CONST(Dcm_CfgDidMgrDidInfoType, TYPEDEF, DCM_CONST) Dcm_CfgDidMgrDidInfoPtrType;
typedef CONSTP2CONST(Dcm_CfgDidMgrDidInfoType, TYPEDEF, DCM_CONST) Dcm_CfgDidMgrDidInfoConstPtrType;
...
typedef P2CONST(Dcm_CfgDidMgrDidOpClassInfoType, TYPEDEF, DCM_CONST) Dcm_CfgDidMgrDidOpClassInfoPtrType;
...
typedef P2CONST(Dcm_CfgDidMgrSignalOpClassInfoType, TYPEDEF, DCM_CONST) Dcm_CfgDidMgrSignalOpClassInfoPtrType;
...
typedef uint8 Dcm_Svc11ResponseType;
...
struct DCM_CFGSVC11SUBFUNCINFOTYPE_TAG
{
  ...
  Dcm_Svc11ResponseType             ResponseType; /*!< The sub function response type */
#endif
};
 ...
 *  Dcm_Service14Cancel()
 ***********************************************************************************************************************/
/*! \brief         Cancels an ongoing service processing.
 *  \details       -
 *  \param[in]     pContext      Pointer to the context
 *  \context       TASK
 *  \reentrant     FALSE
...
extern CONST(uint8, DCM_CONST) Dcm_CfgDiagSvcIdLookUpTable[13];
...
extern CONST(uint8, DCM_CONST) Dcm_CfgSvc19SubFuncLookUpTable[13];
...
extern CONST(Dcm_CfgStateNotificationInfoType, DCM_CONST) Dcm_CfgStateSessionNotificationInfo[1];
/*! Security state change notification(s) */
extern CONST(Dcm_CfgStateNotificationInfoType, DCM_CONST) Dcm_CfgStateSecurityNotificationInfo[1];
/*! DID ranges look up */
...
extern CONST(Dcm_CfgDidMgrOpInfoCombinedType, DCM_CONST) Dcm_CfgDidMgrOpInfoCombined[1];
/*! RID properties */
...
extern CONST(Dcm_CfgDiagServiceInfoType, DCM_CONST) Dcm_CfgDiagServiceInfo[13];
/*! Indirection from diag service info to execution pre conditions */
extern CONST(Dcm_CfgStateRefMemType, DCM_CONST) Dcm_CfgDiagSvcIdExecPrecondTable[12];
...
extern CONST(Dcm_DiagSvcCancelFuncType, DCM_CONST) Dcm_CfgDiagSvcCancellers[7];
...
extern CONST(Dcm_CfgDiagNotificationInfoType, DCM_CONST) Dcm_CfgDiagSysNotificationInfo[1];
/*! DCM service to protocol map */
extern CONST(Dcm_CfgDiagSvc2ProtMapMemType, DCM_CONST) Dcm_CfgDiagSvcId2ProtMap[12];
...
extern CONST(Dcm_CfgSvc19SubFuncInfoType, DCM_CONST) Dcm_CfgSvc19SubFuncInfo[12];
/*! Indirection from service 0x19 sub functions to execution pre conditions */
extern CONST(Dcm_CfgStateRefMemType, DCM_CONST) Dcm_CfgSvc19SubFuncExecPrecondTable[12];
