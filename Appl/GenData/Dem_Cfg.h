...
/* Generator Internal Version                                         22.06.00 (Cfg5.16.x/Cfg5.17.x/Cfg5.18.x compatible, Release AR4-28), Revision: 146775, Variant: Vector */
...
#define DEM_CFG_CLEAR_ALL_DTCS                                             STD_ON       /* Autodetected - via /Dem/DemGeneral/DemClearDTCLimitation == (DEM_ALL_SUPPORTED_DTCS | DEM_ONLY_CLEAR_ALL_DTCS | DEM_ONLY_CLEAR_OBDII_AND_ALL_DTCS | DEM_ONLY_CLEAR_SINGLE_AND_ALL_DTCS | DEM_ONLY_CLEAR_EMISSIONS_SYSTEM_GROUP_AND_ALL_DTCS) */ 
#define DEM_CFG_CLEAR_EMISSIONS_SYSTEM_GROUP_DTCS                          STD_ON       /* Autodetected - via /Dem/DemGeneral/DemClearDTCLimitation == (DEM_ALL_SUPPORTED_DTCS | DEM_ONLY_CLEAR_EMISSIONS_SYSTEM_GROUP_AND_ALL_DTCS) */ 
...
#define DEM_CFG_DATA_DTR                                                   STD_OFF      /* Autodetected - STD_ON: any /Dem/DemGeneral/DemDataClass/DemDataElementInternalData == DEM_DTR exists, STD_OFF: else */ 
...
#define DEM_CFG_DATA_IUMPR                                                 STD_OFF      /* Autodetected - STD_ON: any /Dem/DemGeneral/DemDataClass/DemDataElementInternalData == DEM_IUMPR exists, STD_OFF: else */ 
...
#define DEM_CFG_DATA_MONITOR_ACTIVITY_DATA                                 STD_OFF      /* Autodetected - STD_ON: any /Dem/DemGeneral/DemDataClass/DemDataElementInternalData == DEM_MONITOR_ACTIVITY_DATA exists, STD_OFF: else */ 
...
#define DEM_CFG_NOTIFY_INIT_MONITOR                                        STD_ON       /* Autodetected - STD_ON: /Dem/DemConfigSet/DemEventParameter/DemCallbackInitMForE container(s) exist, STD_OFF: no such container */ 
...
#define DEM_CFG_PROCESS_PIDF501_COMPREHENSIVE_COMPLETE                     STD_OFF      /* (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF) */ 
...
#define DEM_CFG_REPORT_BLINKING_MIL_AS_ACTIVE                              STD_ON       /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
...
#define DEM_CFG_SUPPORT_500MI_DENOMINATOR                                  STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
...
#define DEM_CFG_SUPPORT_CYCLE_OBD_DCY                                      STD_ON       /* Autodetected - STD_ON: cycle type is referenced by any *CycleRef or the /Dem/DemGeneral/DemRestartCycleOnInitRef parameter, STD_OFF: cycle type is not referenced. The '*CycleRef' params are (here 1 refs): /Dem/DemConfigSet/DemEventParameter/DemEventClass/DemAgingCycleRef, ~/DemOperationCycleRef, ~/DemIndicatorAttribute/DemIndicatorFailureCycleRef and ~/DemIndicatorAttribute/DemIndicatorHealingCycleRef. */ 
...
#define DEM_CFG_SUPPORT_DELAY_WUC_TO_DCY                                   STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
...
#define DEM_CFG_SUPPORT_DTR                                                STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
...
#define DEM_CFG_SUPPORT_IGNITION_SPARK                                     STD_ON       /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
...
#define DEM_CFG_SUPPORT_IUMPR                                              STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
...
#define DEM_CFG_SUPPORT_MAJOR_MONITORS                                     STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
...
#define DEM_CFG_SUPPORT_MIL                                                STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
...
#define DEM_CFG_SUPPORT_MULTIPLE_USERDEFINEDMEMORIES                       STD_OFF      /* Autodetected - STD_ON: more than one /Dem/DemGeneral/DemEventMemorySet/DemUserDefinedMemory containers exist, STD_OFF: only one or no such container */ 
...
#define DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS                                  STD_OFF      /* Autodetected - via /Dem/DemGeneral/DemOBDSupport is different from DEM_OBD_NO_OBD_SUPPORT and /Dem/DemGeneral/DemGeneralOBD/DemOBDLegislation == (DEM_OBD_LEGISLATION_OBDII | DEM_OBD_LEGISLATION_OBD_ON_UDS) */ 
#define DEM_CFG_SUPPORT_OBDONUDS                                           STD_OFF      /* Autodetected - via /Dem/DemGeneral/DemOBDSupport is different from DEM_OBD_NO_OBD_SUPPORT and /Dem/DemGeneral/DemGeneralOBD/DemOBDLegislation == DEM_OBD_LEGISLATION_OBD_ON_UDS */ 
#define DEM_CFG_SUPPORT_OBD_HIDE_OCCURRENCES                               STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_OBD_PTO                                            STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
...
#define DEM_CFG_SUPPORT_PBS_DIFFERENT_OBD_VARIANTS                         STD_OFF      /* Autodetected - At least two PBS variant with different /Dem/DemGeneral/DemGeneralOBD/DemOBDLegislation setting.  */ 
#define DEM_CFG_SUPPORT_PENDING_DISPLACE_FREEZE_FRAME                      STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PENDING_STORAGE_FREEZE_FRAME                       STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PENDING_UPDATE_FREEZE_FRAME                        STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PERMANENT                                          STD_OFF      /* Autodetected - via /Dem/DemGeneral/DemMaxNumberEventEntryPermanent > 0 */ 
#define DEM_CFG_SUPPORT_PERMANENTDTC_ACTIVATION_DISTANCE                   STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PERMANENTDTC_IMMEDIATE_VISIBLE                     STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PERMANENT_CONDITION_DCY                            STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PERMANENT_MANDATORY_PFC                            STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PID01                                              STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PID1C                                              STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PID21                                              STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PID30                                              STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PID31                                              STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PID41                                              STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PID4D                                              STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_PID4E                                              STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
...
#define DEM_CFG_SUPPORT_PRIMARY                                            STD_ON       /* Autodetected - via /Dem/DemGeneral/DemEventMemorySet/DemPrimaryMemory/DemMaxNumberEventEntryPrimary > 0 */ 
#define DEM_CFG_SUPPORT_RESTART_CYCLE                                      STD_OFF      /* Vector extension - /Dem/DemGeneral/DemRestartCycleOnInitRef */ 
#define DEM_CFG_SUPPORT_RESTART_DCY_ON_CLEAR_DTC                           STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_WWHOBD == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
...
#define DEM_CFG_SUPPORT_SRECS_CALCULATED                                   STD_ON       /* Autodetected - At least one event with DemTypeOfFreezeFrameRecordNumeration == DEM_FF_RECNUM_CALCULATED or DEM_FF_RECNUM_CALCULATED_FIFO */ 
#define DEM_CFG_SUPPORT_SRECS_CALCULATED_FIFO                              STD_OFF      /* Autodetected - At least one event with DemTypeOfFreezeFrameRecordNumeration == DEM_FF_RECNUM_CALCULATED_FIFO */ 
#define DEM_CFG_SUPPORT_SRECS_CONFIGURED                                   STD_OFF      /* Autodetected - At least one event with DemTypeOfFreezeFrameRecordNumeration == DEM_FF_RECNUM_CONFIGURED */ 
...
#define DEM_CFG_SUPPORT_TRIGGER_FDC                                        STD_OFF      /* STD_ON: any /Dem/DemGeneral/DemFreezeFrameRecNumClass/DemFreezeFrameRecordTrigger has value DEM_RECORD_TRIGGER_FDC, STD_OFF: else. */ 
...
#define DEM_CFG_SUPPORT_USERDEFINEDMEMORY                                  STD_OFF      /* Autodetected - STD_ON: any /Dem/DemGeneral/DemEventMemorySet/DemUserDefinedMemory container(s) exist, STD_OFF: no such container */ 
...
#define DEM_CFG_SUPPORT_VID08                                              STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
#define DEM_CFG_SUPPORT_VID0B                                              STD_OFF      /* ((DEM_CFG_HAS_OBDII_ENABLED == STD_OFF) && (DEM_CFG_SUPPORT_OBDONUDS == STD_OFF)) */ 
...
#define DEM_USE_DUMMY_STATEMENT STD_OFF /* /MICROSAR/vSet/vSetGeneral/vSetDummyStatementKind */
#endif
#ifndef DEM_DUMMY_STATEMENT
#define DEM_DUMMY_STATEMENT(v)  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */  /* /MICROSAR/vSet/vSetGeneral/vSetDummyStatementKind */
#endif
#ifndef DEM_DUMMY_STATEMENT_CONST
#define DEM_DUMMY_STATEMENT_CONST(v)  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */  /* /MICROSAR/vSet/vSetGeneral/vSetDummyStatementKind */
#endif
...
#endif
#ifndef DEM_PROCESSOR_TC387Q
#define DEM_PROCESSOR_TC387Q
#endif
#ifndef DEM_COMP_TASKING
#define DEM_COMP_TASKING
#endif
...
#define DEM_CFG_HAVE_LICENSE_OBDII                                    STD_ON                    /* Licensed feature "Diag_AsrDem_OBDSupport" */
#define DEM_CFG_HAVE_LICENSE_OBDONUDS                                 STD_OFF                 /* Licensed feature "Diag_AsrDem_ObdOnUds" */
#define DEM_CFG_HAVE_LICENSE_WWHOBD                                   STD_OFF                    /* Licensed feature "Diag_AsrDem_WwhObd" */
#define DEM_CFG_HAVE_LICENSE_J1939                                    STD_ON                    /* Licensed feature "Diag_AsrDem_J1939Support" */
...
#endif  /* DEM_CFG_H */
/**********************************************************************************************************************
  END OF FILE: Dem_Cfg.h     [Vector, VARIANT-PRE-COMPILE, 22.06.00.146775]
**********************************************************************************************************************/
