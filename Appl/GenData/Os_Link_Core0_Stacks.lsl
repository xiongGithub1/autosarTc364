...
/* Stack: Default_BSW_ASync_Task_10ms (4096 Byte) */
group OS_STACK_DEFAULT_BSW_ASYNC_TASK_10MS_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select "[.]bss.OS_STACK_DEFAULT_BSW_ASYNC_TASK_10MS_VAR_NOINIT";
}
"_OS_STACK_DEFAULT_BSW_ASYNC_TASK_10MS_VAR_NOINIT_START" = "_lc_gb_OS_STACK_DEFAULT_BSW_ASYNC_TASK_10MS_VAR_NOINIT_GROUP";
"_OS_STACK_DEFAULT_BSW_ASYNC_TASK_10MS_VAR_NOINIT_END" = "_lc_ge_OS_STACK_DEFAULT_BSW_ASYNC_TASK_10MS_VAR_NOINIT_GROUP" - 1;
"_OS_STACK_DEFAULT_BSW_ASYNC_TASK_10MS_VAR_NOINIT_LIMIT" = "_lc_ge_OS_STACK_DEFAULT_BSW_ASYNC_TASK_10MS_VAR_NOINIT_GROUP";
...
group OS_STACK_OSCORE0_TASK_PRIO45_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select "[.]bss.OS_STACK_OSCORE0_TASK_PRIO45_VAR_NOINIT";
}
"_OS_STACK_OSCORE0_TASK_PRIO45_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE0_TASK_PRIO45_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE0_TASK_PRIO45_VAR_NOINIT_END" = "_lc_ge_OS_STACK_OSCORE0_TASK_PRIO45_VAR_NOINIT_GROUP" - 1;
"_OS_STACK_OSCORE0_TASK_PRIO45_VAR_NOINIT_LIMIT" = "_lc_ge_OS_STACK_OSCORE0_TASK_PRIO45_VAR_NOINIT_GROUP";
