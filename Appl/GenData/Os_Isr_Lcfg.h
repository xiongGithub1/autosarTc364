...
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_AdcIsr_G8;
...
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_Uart_ASCLIN0RX_ISR;

/*! ISR configuration data: Uart_ASCLIN0TX_ISR */
extern CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_Uart_ASCLIN0TX_ISR_HwConfig;
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_Uart_ASCLIN0TX_ISR;
...
extern CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_CounterIsr_SystemTimer1_HwConfig;
