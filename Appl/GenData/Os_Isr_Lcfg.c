...
/*! Dynamic ISR data: Uart_ASCLIN0ERR_ISR */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_Uart_ASCLIN0ERR_ISR_Dyn;

/*! Dynamic ISR data: Uart_ASCLIN0RX_ISR */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_Uart_ASCLIN0RX_ISR_Dyn;

/*! Dynamic ISR data: Uart_ASCLIN0TX_ISR */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_Uart_ASCLIN0TX_ISR_Dyn;
...
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_Uart_ASCLIN0ERR_ISR_HwConfig =
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_Uart_ASCLIN0ERR_ISR,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_Uart_ASCLIN0ERR_ISR,
  /* .IsMapped                  = */ FALSE,
  /* .IsPostActionRequired      = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_Uart_ASCLIN0ERR_ISR =
{
  /* .Thread   = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_Uart_ASCLIN0ERR_ISR,
    /* .Context               = */ &OsCfg_Hal_Context_OsCore0_Isr_Level1_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Isr_Core,
    /* .Dyn                   = */ OS_ISR_CASTDYN_ISR_2_THREAD(OsCfg_Isr_Uart_ASCLIN0ERR_ISR_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_Uart_ASCLIN0ERR_ISR_HwConfig,
  /* .IsrId                     = */ Uart_ASCLIN0ERR_ISR,
  /* .IsEnabledOnInitialization = */ TRUE
}
;
/*! ISR configuration data: Uart_ASCLIN0RX_ISR */
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_Uart_ASCLIN0RX_ISR_HwConfig =
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_Uart_ASCLIN0RX_ISR,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_Uart_ASCLIN0RX_ISR,
  /* .IsMapped                  = */ FALSE,
  /* .IsPostActionRequired      = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_Uart_ASCLIN0RX_ISR =
{
  /* .Thread   = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_Uart_ASCLIN0RX_ISR,
    /* .Context               = */ &OsCfg_Hal_Context_OsCore0_Isr_Level2_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Isr_Core,
    /* .Dyn                   = */ OS_ISR_CASTDYN_ISR_2_THREAD(OsCfg_Isr_Uart_ASCLIN0RX_ISR_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_Uart_ASCLIN0RX_ISR_HwConfig,
  /* .IsrId                     = */ Uart_ASCLIN0RX_ISR,
  /* .IsEnabledOnInitialization = */ TRUE
}
;
/*! ISR configuration data: Uart_ASCLIN0TX_ISR */
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_Uart_ASCLIN0TX_ISR_HwConfig =
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_Uart_ASCLIN0TX_ISR,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_Uart_ASCLIN0TX_ISR,
  /* .IsMapped                  = */ FALSE,
  /* .IsPostActionRequired      = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_Uart_ASCLIN0TX_ISR =
{
  /* .Thread   = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_Uart_ASCLIN0TX_ISR,
    /* .Context               = */ &OsCfg_Hal_Context_OsCore0_Isr_Level3_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Isr_Core,
    /* .Dyn                   = */ OS_ISR_CASTDYN_ISR_2_THREAD(OsCfg_Isr_Uart_ASCLIN0TX_ISR_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_Uart_ASCLIN0TX_ISR_HwConfig,
  /* .IsrId                     = */ Uart_ASCLIN0TX_ISR,
  /* .IsEnabledOnInitialization = */ TRUE
}
;
