...
#if defined IPDUM_START_SEC_VAR_NOCACHE_CLEARED_UNSPECIFIED
...
#ifdef MEMMAP_ERROR
# error No MemMap section found in IpduM_MemMap.h. Check your section define for validity.
#endif
