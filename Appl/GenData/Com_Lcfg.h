 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Com_Lcfg.h
 *   Generation Time: 2024-07-09 14:04:10
...
#define Com_GetSizeOfTxAccessInfoOfPCConfig()                                                       2u  /**< the number of accomplishable value elements in Com_TxAccessInfo */
#define Com_GetSizeOfTxBufferOfPCConfig()                                                           33u  /**< the number of accomplishable value elements in Com_TxBuffer */
...
#define Com_GetSizeOfTxPduInfoOfMainFunctionTxIndOfPCConfig()                                       2u  /**< the number of accomplishable value elements in Com_TxPduInfoOfMainFunctionTxInd */
#define Com_GetSizeOfTxPduInfoOfPCConfig()                                                          2u  /**< the number of accomplishable value elements in Com_TxPduInfo */
#define Com_GetSizeOfTxPduInitValueOfPCConfig()                                                     33u  /**< the number of accomplishable value elements in Com_TxPduInitValue */
...
#define Com_GetTxPduInfoOfMainFunctionTxIndEndIdxOfMainFunctionTxStruct(Index)                      ((Com_TxPduInfoOfMainFunctionTxIndEndIdxOfMainFunctionTxStructType)((((Com_TxPduInfoOfMainFunctionTxIndEndIdxOfMainFunctionTxStructType)(Index)) + 2u)))  /**< the end index of the 0:n relation pointing to Com_TxPduInfoOfMainFunctionTxInd */
...
#define Com_GetTimePeriodOfTxModeFalse(Index)                                                       ((Com_TimePeriodOfTxModeFalseType)((((Com_TimePeriodOfTxModeFalseType)(Index)) + 10u)))  /**< Cycle time factor. */
...
#define Com_GetTimePeriodOfTxModeTrue(Index)                                                        ((Com_TimePeriodOfTxModeTrueType)((((Com_TimePeriodOfTxModeTrueType)(Index)) + 10u)))  /**< Cycle time factor. */
...
#define Com_GetTxBufferEndIdxOfTxPduInfo(Index)                                                     ((Com_TxBufferEndIdxOfTxPduInfoType)((((Com_TxBufferEndIdxOfTxPduInfoType)(Index)) + 32u)))  /**< the end index of the 0:n relation pointing to Com_TxBuffer */
...
#define Com_GetTxPduInitValueEndIdxOfTxPduInfo(Index)                                               ((Com_TxPduInitValueEndIdxOfTxPduInfoType)((((Com_TxPduInitValueEndIdxOfTxPduInfoType)(Index)) + 32u)))  /**< the end index of the 0:n relation pointing to Com_TxPduInitValue */
...
{
  Com_CurrentTxModeType msg_MyECU_Lamp_oCAN00_818e1651_Tx;
...
{
  Com_CycleTimeCntType msg_MyECU_Lamp_oCAN00_818e1651_Tx;
...
{
  Com_CyclicSendRequestType msg_MyECU_Lamp_oCAN00_818e1651_Tx;
...
{
  Com_TransmitRequestType msg_MyECU_Lamp_oCAN00_818e1651_Tx;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_TxAccessInfoType, COM_CONST) Com_TxAccessInfo[2];
#define COM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_TxPduInitValueType, COM_CONST) Com_TxPduInitValue[33];
#define COM_STOP_SEC_CONST_8
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Com_TxBufferType, COM_VAR_NO_INIT) Com_TxBuffer[33];
#define COM_STOP_SEC_VAR_NO_INIT_8
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Com_TxPduGrpActiveType, COM_VAR_NO_INIT) Com_TxPduGrpActive[2];
#define COM_STOP_SEC_VAR_NO_INIT_8
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
