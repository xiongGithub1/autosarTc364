...
derivative mpe
{
  ...
  memory PFlash0_Cached
  {
    ...
    type = rom;
    size = 2095360; /* 2 MiB */
    map (dest=bus:local_bus, dest_offset = 0x80000000, size = 2095360);
  }
  memory CoreExceptions_FirstExecInst
  {
    ...
    type = rom;
    size = 512; /* 512 Byte */
    map (dest=bus:local_bus, dest_offset = 0x801FF900, size = 512);
  }
  memory StartupCode_FirstExecInst
  {
    ...
    type = rom;
    size = 1280; /* 1 KiB */
    map (dest=bus:local_bus, dest_offset = 0x801FFB00, size = 1280);
  }
...
section_layout mpe:vtc:linear
{
  ...
  group OS_STACKS_CORE1_VAR_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:DSPR_Core1)
  {
    group OS_STACKS_CORE1_VAR_NOINIT (ordered, contiguous, fill, align = 16)
    {
      section "OS_STACKS_CORE1_VAR_NOINIT_SEC" (blocksize = 2, attributes = rw)
      {
        ...
        select "[.]bss.OS_STACK_OSCORE1_TASK_PRIO20_VAR_NOINIT";
  ...
  group OS_DATA_CORE1_VAR_ROM_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:PFlash0_Cached)
  {
    group OS_DATA_CORE1_VAR_FAST_INIT_ROM (ordered, contiguous, fill, align = 16)
    {
      section "OS_DATA_CORE1_VAR_FAST_INIT_ROM_SEC" (fill, blocksize = 2, attributes = rx)
      {
        group (load_addr)
        {
          ...
          select "[.]zdata.OS_OsApplication_OsCore1_VAR_FAST_SAVED_ZONE";
        }
      }
    }
    ...
    group OS_DATA_CORE1_VAR_INIT_ROM (ordered, contiguous, fill, align = 16)
    {
      section "OS_DATA_CORE1_VAR_INIT_ROM_SEC" (fill, blocksize = 2, attributes = rx)
      {
        group (load_addr)
        {
          ...
          select "[.]data.OS_OsApplication_OsCore1_VAR_SAVED_ZONE";
        }
      }
    }
  ...
  group OS_DATA_CORE1_VAR_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:DSPR_Core1)
  {
    ...
    group OS_DATA_CORE1_VAR_FAST_NOINIT (ordered, contiguous, fill, align = 16)
    {
      section "OS_DATA_CORE1_VAR_FAST_NOINIT_SEC" (blocksize = 2, attributes = rw)
      {
        ...
        select "[.]zbss.OS_OsApplication_OsCore1_VAR_FAST_SAVED_ZONE_NOINIT";
      }
    }
    ...
    group OS_DATA_CORE1_VAR_NOINIT (ordered, contiguous, fill, align = 16)
    {
      section "OS_DATA_CORE1_VAR_NOINIT_SEC" (blocksize = 2, attributes = rw)
      {
        ...
        select "[.]bss.OS_OsApplication_OsCore1_VAR_SAVED_ZONE_NOINIT";
      }
    }
  ...
  group OS_EXCVEC_CORE1_CODE_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:PFlash0_Cached)
  {
  ...
  group OS_EXCVEC_CORE1_CONST_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:PFlash0_Cached)
  {
  ...
  group OS_INTVEC_CORE1_CODE_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:PFlash0_Cached)
  {
  ...
  group OS_INTVEC_CORE1_CONST_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:PFlash0_Cached)
  {
  ...
  group STACK_C1_GROUP (ordered, contiguous, fill, run_addr = mem:mpe:DSPR_Core1)
  {
    group STACK_C1 (ordered, contiguous, fill, align = 64)
    {
      reserved "STACK_C1" (size = 36864);
    }
