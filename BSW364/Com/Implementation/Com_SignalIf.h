...
**********************************************************************************************************************/
/*! \brief        This function calls Com_SendSignal for signals to send the configured invalid value.
    \details      -
    \pre          -
    ...
    \reentrant    TRUE, for different handles
**********************************************************************************************************************/
FUNC(uint8, COM_CODE) Com_InvalidateSignal_SendSignal(Com_TxAccessInfoIterType txAccessInfo);
# endif
...
**********************************************************************************************************************/
/*! \brief        This function calls Com_SendSignal for group signals to send the configured invalid value.
    \details      -
    \pre          -
    \param[in]    txAccessInfo ID of the access info table.
    \return       uint8
    ...
    \reentrant    TRUE, for different handles
**********************************************************************************************************************/
FUNC(uint8, COM_CODE) Com_InvalidateSignal_SendGroupSignal(Com_TxAccessInfoIterType txAccessInfo);
# endif
