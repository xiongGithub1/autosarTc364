...
**********************************************************************************************************************/
FUNC(Std_ReturnType, COM_CODE) Com_TxLLIf_Transmit(Com_TxPduInfoIterType ComTxPduId);
# endif
...
/*! \brief        This function is called by the lower layer to hand a received TP segment to Com.
    ...
    \reentrant    TRUE, for different Handles
**********************************************************************************************************************/
FUNC(BufReq_ReturnType, COM_CODE) Com_CopyRxData_Processing(Com_RxPduInfoIterType rxPduId, CONSTP2VAR(PduInfoType, AUTOMATIC, COM_APPL_DATA) PduInfoPointer,
