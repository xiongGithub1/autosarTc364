...
/*! \brief        This method sets the Com_TxFilterOldValueX
    \details      -
    \pre          -
    \param[in]    idxTxSigInfo      Index of Tx Group Signal Info
    \param[in]    SignalDataPtr     Reference to the signal data to be transmitted.
    \param[in]    Length        Length of the dynamic length signal.
    \context      TASK|ISR2
    \synchronous  TRUE
...
**********************************************************************************************************************/
/*! \brief        This function evaluates the state of the signal filters.
    \details      -
    \pre          -
    ...
    \return       isFilterInfoInd     TRUE, if FilterInfo indirection is used, FALSE if the OnChange indirection is used.
...
**********************************************************************************************************************/
/*! \brief        This function evaluates the state of the group signal filters.
    \details      -
    \pre          -
