...
/*! \brief        This method starts the cyclic transmission of an I-PDU.
    ...
    \reentrant    TRUE, for different Handles
**********************************************************************************************************************/
FUNC(void, COM_CODE) Com_TxModeHdlr_StartCyclicTransmission(Com_TxPduInfoIterType ComTxPduId);
...
**********************************************************************************************************************/
FUNC(void, COM_CODE) Com_TxModeHdlr_StopCyclicTransmission(Com_TxPduInfoIterType ComTxPduId);
# endif
...
**********************************************************************************************************************/
FUNC(void, COM_CODE) Com_TxModeHdlr_TriggerDeferredTransmitAndSetTimer(Com_TxPduInfoIterType ComTxPduId, boolean TriggerWithoutRepetition);
# endif
...
/*! \brief        This method reloads the timer for normal Tx Deadline Monitoring if the timer is not already running.
    ...
    \trace        SPEC-5131191
**********************************************************************************************************************/
FUNC(void, COM_CODE) Com_TxModeHdlr_ReloadTxDlMonCounter(Com_TxPduInfoIterType ComTxPduId);
# endif
...
/*! \brief        This function returns the current repetition period. The repetition period depends on the current tx mode.
    ...
    \context      TASK|ISR2
**********************************************************************************************************************/
FUNC(Com_RepCycleCntType, COM_CODE) Com_TxModeHdlr_GetCurrentRepetitionPeriod(Com_TxPduInfoIterType TxPduId);
# endif
...
/*! \brief        This function returns the current repetition count configuration constant.
    ...
    \context      TASK|ISR2
**********************************************************************************************************************/
FUNC(Com_RepCntType, COM_CODE) Com_TxModeHdlr_GetCurRepCnt(Com_TxPduInfoIterType TxPduId);
# endif
