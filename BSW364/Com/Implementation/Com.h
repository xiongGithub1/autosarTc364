 ...
 *  23.00.01  2022-06-14  viscpe  ESCAN00111201 unresolved external symbol Com_RxInv_Sig_<ApplType>_EvaluateInvalidValue
 *********************************************************************************************************************/
#if !defined (COM_H)
# define COM_H
...
/*!
  ...
  \pre      -
    \{
*/
# define COM_SW_MAJOR_VERSION                 23u    /**< Major version */
...
# define COM_E_IDXOUTOFBOUNDS                            ((uint8)0xA0u) /**< a read index is out-of-bounds and was sanitized. */
# define COM_E_CPRQUEUE_OVERFLOW                         ((uint8)0xB0u) /**< cross partition routing queue overflow. */
# define COM_E_FATAL                                     ((uint8)0xFFu) /**< fatal error. */
/*!
  \}
*/
...
/*! \brief          This function is called by Com whenever a development error occurs.
  ...
  \trace          SPEC-2736947
**********************************************************************************************************************/
# define Com_LMgt_CallDetError(               API_ID, ERROR_CODE )           (void) Det_ReportError( (COM_MODULE_ID), 0u, ((uint8)(API_ID)), ((uint8)(ERROR_CODE)))
...
typedef enum
{
  ...
  COMServiceId_CprQueueDescrGw_Write = 0xA0,
  COMServiceId_CprQueueSigGw_Write_Signal = 0xA2,
  COMServiceId_CprQueueSigGw_Write_SignalGroup = 0xA3
} Com_ServiceIdType;
/*!
  \}
*/
...
extern P2CONST(Com_ConfigType, COM_VAR_CLEARED, COM_PBCFG) Com_ConfigDataPtr;
...
* \usedin Com_DeInit, Com_Init, Com_IPduGroupControl, Com_IPduGroupStart, Com_IPduGroupStop, Com_MainFunctionRxInternal, Com_ReceiveDynSignal, Com_ReceiveSignal, Com_ReceiveSignalGroup, Com_ReceiveSignalGroupArray, Com_RxIndication, Com_TpRxindication
