...
/*! \brief              This function processes the passed ComSignalGroup.
    ...
    \context            TASK|ISR2
**********************************************************************************************************************/
COM_LOCAL_INLINE FUNC(void, COM_CODE) Com_RxProcessing_ProcessSigGrpEvent(Com_RxPduInfoIterType comRxPduInfoIdx, P2CONST(PduInfoType, AUTOMATIC, COM_APPL_DATA) PduInfoPtr,
...
/*! \brief            This function checks if the ISR Lock must be opened
    ...
    \context          TASK
**********************************************************************************************************************/
COM_LOCAL_INLINE FUNC(void, COM_CODE) Com_RxProcessing_ThresholdCheck_Deferred(Com_RxMainFunctionProcessingISRLockCounterIdxOfMainFunctionRxStructType idx,
 ...
 *                been received.
    ...
    \context      TASK
**********************************************************************************************************************/
COM_LOCAL_INLINE FUNC(boolean, COM_CODE) Com_RxProcessing_IsDeferredProcessingRequested(Com_RxPduInfoIterType idxRxPduInfo);
#endif
...
/*! \brief              This function processes a deferred PDU.
    ...
    \context            TASK
**********************************************************************************************************************/
COM_LOCAL_INLINE FUNC(void, COM_CODE) Com_RxProcessDeferredPDU(Com_RxPduInfoIterType idxRxPduInfo, P2VAR(FctPtrCacheStrct, AUTOMATIC, COM_APPL_DATA) deferredfctPtrCacheStrctPtr);
#endif
...
/*! \brief             This function shall perform the processing of the AUTOSAR COM receive processing that are not directly
    ...
    \context           TASK
**********************************************************************************************************************/
COM_LOCAL_INLINE FUNC(void, COM_CODE) Com_RxDeferredPduProcessing_IterateOverAllRxPdus(Com_MainFunctionRxStructIterType mainFunctionId,
                                                                                       P2VAR(FctPtrCacheStrct, AUTOMATIC, COM_APPL_DATA) deferredFctPtrCacheStrct);
#endif
...
#  if (COM_EXISTS_TMPRXSHDBUFFERUINT8_TMPBUFFEROFRXACCESSINFO == STD_ON)
        case COM_TMPRXSHDBUFFERUINT8_TMPBUFFEROFRXACCESSINFO:
        {
          ...
          Com_SetTmpRxShdBufferUInt8(Com_GetTmpBufferIdxOfRxAccessInfo(idxRxAccessInfo), signalValue);  /* SBSW_COM_CSL04 */
          break;
        }
#  endif
#  if (COM_EXISTS_TMPRXSHDBUFFERSINT8_TMPBUFFEROFRXACCESSINFO == STD_ON)
        case COM_TMPRXSHDBUFFERSINT8_TMPBUFFEROFRXACCESSINFO:
        {
          ...
          Com_SetTmpRxShdBufferSInt8(Com_GetTmpBufferIdxOfRxAccessInfo(idxRxAccessInfo), signalValue);  /* SBSW_COM_CSL04 */
          break;
        }
#  endif
#  if (COM_EXISTS_TMPRXSHDBUFFERUINT16_TMPBUFFEROFRXACCESSINFO == STD_ON)
        case COM_TMPRXSHDBUFFERUINT16_TMPBUFFEROFRXACCESSINFO:
        {
          ...
          Com_SetTmpRxShdBufferUInt16(Com_GetTmpBufferIdxOfRxAccessInfo(idxRxAccessInfo), signalValue); /* SBSW_COM_CSL04 */
          break;
        }
#  endif
#  if (COM_EXISTS_TMPRXSHDBUFFERSINT16_TMPBUFFEROFRXACCESSINFO == STD_ON)
        case COM_TMPRXSHDBUFFERSINT16_TMPBUFFEROFRXACCESSINFO:
        {
          ...
          Com_SetTmpRxShdBufferSInt16(Com_GetTmpBufferIdxOfRxAccessInfo(idxRxAccessInfo), signalValue); /* SBSW_COM_CSL04 */
          break;
        }
#  endif
#  if (COM_EXISTS_TMPRXSHDBUFFERUINT32_TMPBUFFEROFRXACCESSINFO == STD_ON)
        case COM_TMPRXSHDBUFFERUINT32_TMPBUFFEROFRXACCESSINFO:
        {
          ...
          Com_SetTmpRxShdBufferUInt32(Com_GetTmpBufferIdxOfRxAccessInfo(idxRxAccessInfo), signalValue); /* SBSW_COM_CSL04 */
          break;
        }
#  endif
#  if (COM_EXISTS_TMPRXSHDBUFFERSINT32_TMPBUFFEROFRXACCESSINFO == STD_ON)
        case COM_TMPRXSHDBUFFERSINT32_TMPBUFFEROFRXACCESSINFO:
        {
          ...
          Com_SetTmpRxShdBufferSInt32(Com_GetTmpBufferIdxOfRxAccessInfo(idxRxAccessInfo), signalValue); /* SBSW_COM_CSL04 */
          break;
        }
#  endif
#  if (COM_EXISTS_TMPRXSHDBUFFERUINT64_TMPBUFFEROFRXACCESSINFO == STD_ON)
        case COM_TMPRXSHDBUFFERUINT64_TMPBUFFEROFRXACCESSINFO:
        {
          ...
          Com_SetTmpRxShdBufferUInt64(Com_GetTmpBufferIdxOfRxAccessInfo(idxRxAccessInfo), signalValue); /* SBSW_COM_CSL04 */
          break;
        }
#  endif
#  if (COM_EXISTS_TMPRXSHDBUFFERSINT64_TMPBUFFEROFRXACCESSINFO == STD_ON)
        case COM_TMPRXSHDBUFFERSINT64_TMPBUFFEROFRXACCESSINFO:
        {
          ...
          Com_SetTmpRxShdBufferSInt64(Com_GetTmpBufferIdxOfRxAccessInfo(idxRxAccessInfo), signalValue); /* SBSW_COM_CSL04 */
          break;
        }
#  endif
#  if (COM_EXISTS_TMPRXSHDBUFFERFLOAT32_TMPBUFFEROFRXACCESSINFO == STD_ON)
        case COM_TMPRXSHDBUFFERFLOAT32_TMPBUFFEROFRXACCESSINFO:
        {
          ...
          Com_SetTmpRxShdBufferFloat32(Com_GetTmpBufferIdxOfRxAccessInfo(idxRxAccessInfo), signalValue);        /* SBSW_COM_CSL04 */
          break;
        }
#  endif
#  if (COM_EXISTS_TMPRXSHDBUFFERFLOAT64_TMPBUFFEROFRXACCESSINFO == STD_ON)
        case COM_TMPRXSHDBUFFERFLOAT64_TMPBUFFEROFRXACCESSINFO:
        {
          ...
          Com_SetTmpRxShdBufferFloat64(Com_GetTmpBufferIdxOfRxAccessInfo(idxRxAccessInfo), signalValue);        /* SBSW_COM_CSL04 */
          break;
        }
#  endif
...
# if (COM_TMPRXSHDBUFFERARRAYBASED == STD_ON)
    if(Com_IsTmpRxShdBufferArrayBasedTmpBufferUsedOfRxAccessInfo(idxRxAccessInfo)) /* COV_COM_ONLY_ARRAYBASED_RX_SIGGRP_SIG_01 */
    {
...
#  if (COM_EXISTS_UINT8_N_APPLTYPEOFRXACCESSINFO == STD_ON)
        ...
        {
          P2CONST(uint8, AUTOMATIC, COM_VAR_NO_INIT) SignalBusSourcePtr;
...
# if ((COM_SHDBUFFERUSEDOFRXACCESSINFO == STD_ON)||((COM_RXSIGBUFFERARRAYBASEDSHDBUFFERUSEDOFRXACCESSINFO == STD_ON) && (COM_EXISTS_UINT8_N_APPLTYPEOFRXACCESSINFO == STD_ON)))
    ...
    for(; RxAccessInfoIndidx < Com_GetRxAccessInfoGrpSigIndEndIdxOfRxSigGrpInfo(idxRxSigGrpInfo); RxAccessInfoIndidx++)
    {
      ...
      if(Com_IsFilterInfoUsedOfRxAccessInfo(idxRxAccessInfo) && Com_IsShdBufferUsedOfRxAccessInfo(idxRxAccessInfo) && Com_IsTmpBufferUsedOfRxAccessInfo(idxRxAccessInfo)) /* COV_COM_CSL03_ISUSED_OPTIONAL_INDIRECTION */ /* This Function is only called when the const value IsFilterEvent is true, which is only the case if the SigGrp has any filters configured */
      {
        switch (Com_GetApplTypeOfRxAccessInfo(idxRxAccessInfo))
        {
#  if ((COM_TMPRXSHDBUFFERUINT8 == STD_ON) && (COM_FILTERINFO_UINT8 == STD_ON))
          ...
          {
            if((Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_UINT8_FILTERINFOOFRXACCESSINFO) &&
               (Com_GetTmpBufferOfRxAccessInfo(idxRxAccessInfo) == COM_TMPRXSHDBUFFERUINT8_TMPBUFFEROFRXACCESSINFO) &&
...
#  if ((COM_TMPRXSHDBUFFERSINT8 == STD_ON) && (COM_FILTERINFO_SINT8 == STD_ON))
          ...
          {
            if((Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_SINT8_FILTERINFOOFRXACCESSINFO) &&
               (Com_GetTmpBufferOfRxAccessInfo(idxRxAccessInfo) == COM_TMPRXSHDBUFFERSINT8_TMPBUFFEROFRXACCESSINFO) &&
...
#  if ((COM_TMPRXSHDBUFFERUINT16 == STD_ON) && (COM_FILTERINFO_UINT16 == STD_ON))
          ...
          {
            if((Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_UINT16_FILTERINFOOFRXACCESSINFO) &&
               (Com_GetTmpBufferOfRxAccessInfo(idxRxAccessInfo) == COM_TMPRXSHDBUFFERUINT16_TMPBUFFEROFRXACCESSINFO) &&
...
#  if ((COM_TMPRXSHDBUFFERSINT16 == STD_ON) && (COM_FILTERINFO_SINT16 == STD_ON))
          ...
          {
            if((Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_SINT16_FILTERINFOOFRXACCESSINFO) &&
               (Com_GetTmpBufferOfRxAccessInfo(idxRxAccessInfo) == COM_TMPRXSHDBUFFERSINT16_TMPBUFFEROFRXACCESSINFO) &&
...
#  if ((COM_TMPRXSHDBUFFERUINT32 == STD_ON) && (COM_FILTERINFO_UINT32 == STD_ON))
          ...
          {
            if((Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_UINT32_FILTERINFOOFRXACCESSINFO) &&
               (Com_GetTmpBufferOfRxAccessInfo(idxRxAccessInfo) == COM_TMPRXSHDBUFFERUINT32_TMPBUFFEROFRXACCESSINFO) &&
...
#  if ((COM_TMPRXSHDBUFFERSINT32 == STD_ON) && (COM_FILTERINFO_SINT32 == STD_ON))
          ...
          {
            if((Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_SINT32_FILTERINFOOFRXACCESSINFO) &&
               (Com_GetTmpBufferOfRxAccessInfo(idxRxAccessInfo) == COM_TMPRXSHDBUFFERSINT32_TMPBUFFEROFRXACCESSINFO) &&
...
#  if ((COM_TMPRXSHDBUFFERUINT64 == STD_ON) && (COM_FILTERINFO_UINT64 == STD_ON))
          ...
          {
            if((Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_UINT64_FILTERINFOOFRXACCESSINFO) &&
               (Com_GetTmpBufferOfRxAccessInfo(idxRxAccessInfo) == COM_TMPRXSHDBUFFERUINT64_TMPBUFFEROFRXACCESSINFO) &&
...
#  if ((COM_TMPRXSHDBUFFERSINT64 == STD_ON) && (COM_FILTERINFO_SINT64 == STD_ON))
          ...
          {
            if((Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_SINT64_FILTERINFOOFRXACCESSINFO) &&
               (Com_GetTmpBufferOfRxAccessInfo(idxRxAccessInfo) == COM_TMPRXSHDBUFFERSINT64_TMPBUFFEROFRXACCESSINFO) &&
...
#  if((COM_TMPRXSHDBUFFERARRAYBASED == STD_ON) && (COM_FILTERINFO_UINT8_N == STD_ON))
      if(Com_GetApplTypeOfRxAccessInfo(idxRxAccessInfo) == COM_UINT8_N_APPLTYPEOFRXACCESSINFO) 
      {
        if(Com_IsFilterInfoUsedOfRxAccessInfo(idxRxAccessInfo) && Com_IsRxSigBufferArrayBasedShdBufferUsedOfRxAccessInfo(idxRxAccessInfo) && Com_IsTmpRxShdBufferArrayBasedTmpBufferUsedOfRxAccessInfo(idxRxAccessInfo)) /* COV_COM_CSL03_ISUSED_OPTIONAL_INDIRECTION */ /* This Function is only called when the const value IsFilterEvent is true, which is only the case if the SigGrp has any filters configured. SignalLength is guaranteed to be greater than 0 so the buffer is always present */
        {
...
COM_LOCAL_INLINE FUNC(boolean, COM_CODE) Com_RxProcessing_CheckSigGrpUB(P2CONST(PduInfoType, AUTOMATIC, COM_APPL_DATA) PduInfoPtr, Com_RxSigGrpInfoIterType idxRxSigGrpInfo)
{
  ...
  if(NULL_PTR != PduInfoPtr->SduDataPtr)        /* COV_COM_FEATURE_ALWAYS_TRUE_TX */
  {
    if(Com_IsUbMaskUsedOfRxSigGrpInfo(idxRxSigGrpInfo)  && Com_IsUbIdxUsedOfRxSigGrpInfo(idxRxSigGrpInfo)) /* COV_COM_FEATURE_ALWAYS_TRUE_UB */
    {
      ...
      else if((Com_GetUbMaskOfRxSigGrpInfo(idxRxSigGrpInfo) == COM_CONSTVALUEUINT8_UBMASKOFRXSIGGRPINFO) && (0u == (PduInfoPtr->SduDataPtr[Com_GetUbIdxOfRxSigGrpInfo(idxRxSigGrpInfo)] & Com_GetConstValueUInt8(Com_GetUbMaskIdxOfRxSigGrpInfo(idxRxSigGrpInfo)))))    /* PRQA S 2822 */ /* MD_Com_2822 */ /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */ /* type of mask is always uint8 */
      {
        /* Update-bit not set */
        retVal = FALSE;
      }
...
COM_LOCAL_INLINE FUNC(boolean, COM_CODE) Com_RxProcessing_CheckSigUB(Com_RxSigInfoIterType idxRxSigInfo, P2CONST(PduInfoType, AUTOMATIC, COM_APPL_DATA) PduInfoPtr)
{
  ...
  if(NULL_PTR != PduInfoPtr->SduDataPtr)        /* COV_COM_FEATURE_ALWAYS_TRUE_TX */
  {
    if(Com_IsUbMaskUsedOfRxSigInfo(idxRxSigInfo) && Com_IsUbIdxUsedOfRxSigInfo(idxRxSigInfo))       /* COV_COM_FEATURE_ALWAYS_TRUE_UB */
    {
      ...
      else if((Com_GetUbMaskOfRxSigInfo(idxRxSigInfo) == COM_CONSTVALUEUINT8_UBMASKOFRXSIGINFO) && (0u == (PduInfoPtr->SduDataPtr[Com_GetUbIdxOfRxSigInfo(idxRxSigInfo)] & Com_GetConstValueUInt8(Com_GetUbMaskIdxOfRxSigInfo(idxRxSigInfo))))) /* PRQA S 2822 */ /* MD_Com_2822 */ /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */ /* type of mask is always uint8 */
      {
        /* Update-bit not set */
        retVal = FALSE;
      }
 ...
 *
**********************************************************************************************************************/
COM_LOCAL_INLINE FUNC(void, COM_CODE) Com_RxProcessing_ProcessSigGrpEvent(Com_RxPduInfoIterType comRxPduInfoIdx, P2CONST(PduInfoType, AUTOMATIC, COM_APPL_DATA) PduInfoPtr, Com_RxSigGrpInfoIterType idxRxSigGrpInfo, P2VAR(FctPtrCacheStrct, AUTOMATIC, COM_APPL_DATA) fctPtrCacheStrctPtr)    /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
{
...
# if (COM_ARRAYACCESSUSEDOFRXSIGGRPINFO == STD_ON)
  ...
  if(Com_IsArrayAccessUsedOfRxSigGrpInfo(idxRxSigGrpInfo))      /* COV_COM_FEATURE_ALWAYS_TRUE_TX */
  {
    ...
    P2CONST(uint8, AUTOMATIC, COM_VAR_NO_INIT) SignalSourcePtr = &(PduInfoPtr->SduDataPtr[Com_GetStartBytePositionOfRxSigGrpInfo(idxRxSigGrpInfo)]);     /* PRQA S 2822 */ /* MD_Com_2822 */
...
# if (COM_SHDBUFFERREQUIREDOFRXSIGGRPINFO == STD_ON)
  ...
  if(Com_IsShdBufferRequiredOfRxSigGrpInfo(idxRxSigGrpInfo))    /* COV_COM_SHDBUFFER_REQUIRED */ /* PRQA S 2842 */ /* MD_Com_2842 */
  {
 ...
 *
**********************************************************************************************************************/
FUNC(void, COM_CODE) Com_RxProcessing_ExitExclusiveArea_Deferred(Com_RxMainFunctionProcessingISRLockCounterIdxOfMainFunctionRxStructType idx)
{
  /* #05 Reload the counter with the threshold value */
  Com_SetRxMainFunctionProcessingISRLockCounter(idx, Com_GetRxMainFunctionProcessingISRLockThreshold());        /* SBSW_COM_CSL_VAR_ACCESS */
 ...
 *
**********************************************************************************************************************/
COM_LOCAL_INLINE FUNC(void, COM_CODE) Com_RxProcessing_ThresholdCheck_Deferred(Com_RxMainFunctionProcessingISRLockCounterIdxOfMainFunctionRxStructType idx, P2VAR(FctPtrCacheStrct, AUTOMATIC, COM_APPL_DATA) fctPtrCacheStrctPtr)      /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
{
  if(Com_GetRxMainFunctionProcessingISRLockCounter(idx) > 0u)
  {
    Com_DecRxMainFunctionProcessingISRLockCounter(idx); /* SBSW_COM_CSL_VAR_ACCESS */
  }
  else
  {
 ...
 *
**********************************************************************************************************************/
COM_LOCAL_INLINE FUNC(void, COM_CODE) Com_RxProcessDeferredPDU(Com_RxPduInfoIterType idxRxPduInfo, P2VAR(FctPtrCacheStrct, AUTOMATIC, COM_APPL_DATA) deferredfctPtrCacheStrctPtr)       /* PRQA S 3206, 3673 */ /* MD_Com_3206, MD_MSR_Rule8.13 */
{
  PduInfoType PduInfo;
...
# if (COM_RXTPINFOUSEDOFRXPDUINFO == STD_ON)
    case COM_TP_TYPEOFRXPDUINFO:
    {
      ...
      if(Com_IsRxTpInfoUsedOfRxPduInfo(idxRxPduInfo))   /* COV_COM_CSL03_ISUSED_OPTIONAL_INDIRECTION */ /* RxTpInfo always exists for a tp pdu */
      {
...
COM_LOCAL_INLINE FUNC(void, COM_CODE) Com_RxDeferredPduProcessing_IterateOverAllRxPdus(Com_MainFunctionRxStructIterType mainFunctionId,
                                                                                       P2VAR(FctPtrCacheStrct, AUTOMATIC, COM_APPL_DATA) deferredFctPtrCacheStrct)
{
  Com_RxPduInfoIterType idxRxPduInfo;

  if(Com_IsRxPduInfoOfMainFunctionRxIndUsedOfMainFunctionRxStruct(mainFunctionId))      /* COV_COM_SILENT_TX */
  {
    Com_RxPduInfoOfMainFunctionRxIndIterType rxPduInfoIndIdx = Com_GetRxPduInfoOfMainFunctionRxIndStartIdxOfMainFunctionRxStruct(mainFunctionId);
    Com_RxMainFunctionProcessingISRLockCounterIdxOfMainFunctionRxStructType rxMainFunctionProcessingISRLockCounteridx =
      Com_GetRxMainFunctionProcessingISRLockCounterIdxOfMainFunctionRxStruct(mainFunctionId);

# if (COM_RXDEFERREDEVENTCACHE == STD_ON)
    /* #10 Reset deferred event caching index */
    Com_SetRxDeferredEventCacheIdxOfRxNextEventCacheEntry(Com_GetRxNextEventCacheEntryIdxOfMainFunctionRxStruct(mainFunctionId), 0);    /* SBSW_COM_CSL_VAR_ACCESS */
# endif
    /* #20 Iterate over all Rx ComIPdus and If a "process deferred" flag is set, process that Rx ComIPdu */
    for(; rxPduInfoIndIdx < Com_GetRxPduInfoOfMainFunctionRxIndEndIdxOfMainFunctionRxStruct(mainFunctionId); rxPduInfoIndIdx++)
    {
      idxRxPduInfo = Com_GetRxPduInfoOfMainFunctionRxInd(rxPduInfoIndIdx);
      if(Com_RxProcessing_IsDeferredProcessingRequested(idxRxPduInfo) == TRUE)
      {
        Com_RxProcessDeferredPDU(idxRxPduInfo, deferredFctPtrCacheStrct);       /* SBSW_COM_FCTPTR_CACHE_PTR_1 */
      } /* Is HandleRxPduDeferred Used */
      Com_RxProcessing_ThresholdCheck_Deferred(rxMainFunctionProcessingISRLockCounteridx, deferredFctPtrCacheStrct);    /* SBSW_COM_FCTPTR_CACHE_PTR_1 */
    }
  }
}
#endif
...
#  endif
      if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_UINT8_FILTERINFOOFRXACCESSINFO) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERUINT8_BUFFEROFRXACCESSINFO)) /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
      {
        filterState =
...
# endif
  {
    if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERUINT8_BUFFEROFRXACCESSINFO))  /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
    {
      Com_BufferIdxOfRxAccessInfoType idxBuffer = Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo);
      Com_SetRxSigBufferUInt8(idxBuffer, tmpNewValue);  /* SBSW_COM_CSL04 */
    }
  }

# if (COM_EXISTS_MINPROCGWBUFFERUINT8_MINPROCGWBUFFEROFRXACCESSINFO == STD_ON)
  if(Com_IsMinProcGwBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetMinProcGwBufferOfRxAccessInfo(idxRxAccessInfo) == COM_MINPROCGWBUFFERUINT8_MINPROCGWBUFFEROFRXACCESSINFO))     /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
  {
    Com_SetMinProcGwBufferUInt8(Com_GetMinProcGwBufferIdxOfRxAccessInfo(idxRxAccessInfo), tmpNewValue); /* SBSW_COM_CSL04 */
  }
# endif
...
#  endif
      if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_SINT8_FILTERINFOOFRXACCESSINFO) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERSINT8_BUFFEROFRXACCESSINFO)) /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
      {
        filterState =
...
# endif
  {
    if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERSINT8_BUFFEROFRXACCESSINFO))  /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
    {
      Com_BufferIdxOfRxAccessInfoType idxBuffer = Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo);
      Com_SetRxSigBufferSInt8(idxBuffer, tmpNewValue);  /* SBSW_COM_CSL04 */
    }
  }

# if (COM_EXISTS_MINPROCGWBUFFERSINT8_MINPROCGWBUFFEROFRXACCESSINFO == STD_ON)
  if(Com_IsMinProcGwBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetMinProcGwBufferOfRxAccessInfo(idxRxAccessInfo) == COM_MINPROCGWBUFFERSINT8_MINPROCGWBUFFEROFRXACCESSINFO))     /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
  {
    Com_SetMinProcGwBufferSInt8(Com_GetMinProcGwBufferIdxOfRxAccessInfo(idxRxAccessInfo), tmpNewValue); /* SBSW_COM_CSL04 */
  }
# endif
...
#  endif
      if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_UINT16_FILTERINFOOFRXACCESSINFO) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERUINT16_BUFFEROFRXACCESSINFO))       /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
      {
        filterState =
...
# endif
  {
    if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERUINT16_BUFFEROFRXACCESSINFO)) /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
    {
      Com_BufferIdxOfRxAccessInfoType idxBuffer = Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo);
      Com_SetRxSigBufferUInt16(idxBuffer, tmpNewValue); /* SBSW_COM_CSL04 */
    }
  }

# if (COM_EXISTS_MINPROCGWBUFFERUINT16_MINPROCGWBUFFEROFRXACCESSINFO == STD_ON)
  if(Com_IsMinProcGwBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetMinProcGwBufferOfRxAccessInfo(idxRxAccessInfo) == COM_MINPROCGWBUFFERUINT16_MINPROCGWBUFFEROFRXACCESSINFO))    /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
  {
    Com_SetMinProcGwBufferUInt16(Com_GetMinProcGwBufferIdxOfRxAccessInfo(idxRxAccessInfo), tmpNewValue);        /* SBSW_COM_CSL04 */
  }
# endif
...
#  endif
      if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_SINT16_FILTERINFOOFRXACCESSINFO) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERSINT16_BUFFEROFRXACCESSINFO))       /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
      {
        filterState =
...
# endif
  {
    if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERSINT16_BUFFEROFRXACCESSINFO)) /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
    {
      Com_BufferIdxOfRxAccessInfoType idxBuffer = Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo);
      Com_SetRxSigBufferSInt16(idxBuffer, tmpNewValue); /* SBSW_COM_CSL04 */
    }
  }

# if (COM_EXISTS_MINPROCGWBUFFERSINT16_MINPROCGWBUFFEROFRXACCESSINFO == STD_ON)
  if(Com_IsMinProcGwBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetMinProcGwBufferOfRxAccessInfo(idxRxAccessInfo) == COM_MINPROCGWBUFFERSINT16_MINPROCGWBUFFEROFRXACCESSINFO))    /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
  {
    Com_SetMinProcGwBufferSInt16(Com_GetMinProcGwBufferIdxOfRxAccessInfo(idxRxAccessInfo), tmpNewValue);        /* SBSW_COM_CSL04 */
  }
# endif
...
#  endif
      if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_UINT32_FILTERINFOOFRXACCESSINFO) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERUINT32_BUFFEROFRXACCESSINFO))       /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
      {
        filterState =
...
# endif
  {
    if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERUINT32_BUFFEROFRXACCESSINFO)) /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
    {
      Com_BufferIdxOfRxAccessInfoType idxBuffer = Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo);
      Com_SetRxSigBufferUInt32(idxBuffer, tmpNewValue); /* SBSW_COM_CSL04 */
    }
  }

# if (COM_EXISTS_MINPROCGWBUFFERUINT32_MINPROCGWBUFFEROFRXACCESSINFO == STD_ON)
  if(Com_IsMinProcGwBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetMinProcGwBufferOfRxAccessInfo(idxRxAccessInfo) == COM_MINPROCGWBUFFERUINT32_MINPROCGWBUFFEROFRXACCESSINFO))    /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
  {
    Com_SetMinProcGwBufferUInt32(Com_GetMinProcGwBufferIdxOfRxAccessInfo(idxRxAccessInfo), tmpNewValue);        /* SBSW_COM_CSL04 */
  }
# endif
...
#  endif
      if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_SINT32_FILTERINFOOFRXACCESSINFO) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERSINT32_BUFFEROFRXACCESSINFO))       /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
      {
        filterState =
...
# endif
  {
    if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERSINT32_BUFFEROFRXACCESSINFO)) /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
    {
      Com_BufferIdxOfRxAccessInfoType idxBuffer = Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo);
      Com_SetRxSigBufferSInt32(idxBuffer, tmpNewValue); /* SBSW_COM_CSL04 */
    }
  }

# if (COM_EXISTS_MINPROCGWBUFFERSINT32_MINPROCGWBUFFEROFRXACCESSINFO == STD_ON)
  if(Com_IsMinProcGwBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetMinProcGwBufferOfRxAccessInfo(idxRxAccessInfo) == COM_MINPROCGWBUFFERSINT32_MINPROCGWBUFFEROFRXACCESSINFO))    /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
  {
    Com_SetMinProcGwBufferSInt32(Com_GetMinProcGwBufferIdxOfRxAccessInfo(idxRxAccessInfo), tmpNewValue);        /* SBSW_COM_CSL04 */
  }
# endif
...
#  endif
      if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_UINT64_FILTERINFOOFRXACCESSINFO) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERUINT64_BUFFEROFRXACCESSINFO))       /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
      {
        filterState =
...
# endif
  {
    if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERUINT64_BUFFEROFRXACCESSINFO)) /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
    {
      Com_BufferIdxOfRxAccessInfoType idxBuffer = Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo);
      Com_SetRxSigBufferUInt64(idxBuffer, tmpNewValue); /* SBSW_COM_CSL04 */
    }
  }

# if (COM_EXISTS_MINPROCGWBUFFERUINT64_MINPROCGWBUFFEROFRXACCESSINFO == STD_ON)
  if(Com_IsMinProcGwBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetMinProcGwBufferOfRxAccessInfo(idxRxAccessInfo) == COM_MINPROCGWBUFFERUINT64_MINPROCGWBUFFEROFRXACCESSINFO))    /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
  {
    Com_SetMinProcGwBufferUInt64(Com_GetMinProcGwBufferIdxOfRxAccessInfo(idxRxAccessInfo), tmpNewValue);        /* SBSW_COM_CSL04 */
  }
# endif
...
#  endif
      if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_SINT64_FILTERINFOOFRXACCESSINFO) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERSINT64_BUFFEROFRXACCESSINFO))       /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
      {
        filterState =
...
# endif
  {
    if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERSINT64_BUFFEROFRXACCESSINFO)) /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
    {
      Com_BufferIdxOfRxAccessInfoType idxBuffer = Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo);
      Com_SetRxSigBufferSInt64(idxBuffer, tmpNewValue); /* SBSW_COM_CSL04 */
    }
  }

# if (COM_EXISTS_MINPROCGWBUFFERSINT64_MINPROCGWBUFFEROFRXACCESSINFO == STD_ON)
  if(Com_IsMinProcGwBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetMinProcGwBufferOfRxAccessInfo(idxRxAccessInfo) == COM_MINPROCGWBUFFERSINT64_MINPROCGWBUFFEROFRXACCESSINFO))    /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
  {
    Com_SetMinProcGwBufferSInt64(Com_GetMinProcGwBufferIdxOfRxAccessInfo(idxRxAccessInfo), tmpNewValue);        /* SBSW_COM_CSL04 */
  }
# endif
...
#  endif
      if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_FLOAT32_FILTERINFOOFRXACCESSINFO) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERFLOAT32_BUFFEROFRXACCESSINFO))     /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
      {
        filterState =
...
# endif
  {
    if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERFLOAT32_BUFFEROFRXACCESSINFO))        /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
    {
      Com_BufferIdxOfRxAccessInfoType idxBuffer = Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo);
      Com_SetRxSigBufferFloat32(idxBuffer, tmpNewValue);        /* SBSW_COM_CSL04 */
    }
  }

# if (COM_EXISTS_MINPROCGWBUFFERFLOAT32_MINPROCGWBUFFEROFRXACCESSINFO == STD_ON)
  if(Com_IsMinProcGwBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetMinProcGwBufferOfRxAccessInfo(idxRxAccessInfo) == COM_MINPROCGWBUFFERFLOAT32_MINPROCGWBUFFEROFRXACCESSINFO))   /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
  {
    Com_SetMinProcGwBufferFloat32(Com_GetMinProcGwBufferIdxOfRxAccessInfo(idxRxAccessInfo), tmpNewValue);       /* SBSW_COM_CSL04 */
  }
# endif
...
#  endif
      if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetFilterInfoOfRxAccessInfo(idxRxAccessInfo) == COM_FILTERINFO_FLOAT64_FILTERINFOOFRXACCESSINFO) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERFLOAT64_BUFFEROFRXACCESSINFO))     /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
      {
        filterState =
...
# endif
  {
    if(Com_IsBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetBufferOfRxAccessInfo(idxRxAccessInfo) == COM_RXSIGBUFFERFLOAT64_BUFFEROFRXACCESSINFO))        /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
    {
      Com_BufferIdxOfRxAccessInfoType idxBuffer = Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo);
      Com_SetRxSigBufferFloat64(idxBuffer, tmpNewValue);        /* SBSW_COM_CSL04 */
    }
  }

# if (COM_EXISTS_MINPROCGWBUFFERFLOAT64_MINPROCGWBUFFEROFRXACCESSINFO == STD_ON)
  if(Com_IsMinProcGwBufferUsedOfRxAccessInfo(idxRxAccessInfo) && (Com_GetMinProcGwBufferOfRxAccessInfo(idxRxAccessInfo) == COM_MINPROCGWBUFFERFLOAT64_MINPROCGWBUFFEROFRXACCESSINFO))   /* COV_COM_CSL04_DESTINATION_ENUM_CHECK */
  {
    Com_SetMinProcGwBufferFloat64(Com_GetMinProcGwBufferIdxOfRxAccessInfo(idxRxAccessInfo), tmpNewValue);       /* SBSW_COM_CSL04 */
  }
# endif
...
COM_LOCAL_INLINE FUNC(Com_RxSigProcessState, COM_CODE) Com_RxSignalProcessing_UINT8_N(P2CONST(PduInfoType, AUTOMATIC, COM_APPL_DATA) PduInfoPtr, Com_RxAccessInfoIterType idxRxAccessInfo)      /* COV_COM_APPLTYPEOFRXACCESSINFO */
{
  ...
  P2CONST(uint8, AUTOMATIC, COM_VAR_NO_INIT) newValuePtr = &(PduInfoPtr->SduDataPtr[Com_GetStartByteInPduPositionOfRxAccessInfo(idxRxAccessInfo)]);
...
# if ((COM_FILTERINFOUSEDOFRXACCESSINFO == STD_ON) && (COM_FILTERINFO_UINT8_N == STD_ON))
  {
    if(Com_IsFilterInfoUsedOfRxAccessInfo(idxRxAccessInfo))     /* COV_COM_FEATURE_ALWAYS_TRUE_TX */
    {
      boolean filterState = TRUE;       /* PRQA S 2981 */ /* MD_MSR_RetVal */
...
COM_LOCAL_INLINE FUNC(Com_RxSigProcessState, COM_CODE) Com_RxSignalProcessing_UINT8_DYN(P2CONST(PduInfoType, AUTOMATIC, COM_APPL_DATA) PduInfoPtr, Com_RxAccessInfoIterType idxRxAccessInfo)
{
  ...
  P2CONST(uint8, AUTOMATIC, COM_VAR_NO_INIT) newValuePtr;
 ...
 *
**********************************************************************************************************************/
FUNC(void, COM_CODE) Com_RxProcessing_InitRxIpdu(Com_RxPduInfoIterType rxPduId)
{
...
# if (COM_RXACCESSINFOINDENDIDXOFRXPDUINFO == STD_ON)
  {
    ...
    Com_RxAccessInfoIndEndIdxOfRxPduInfoType com_RxAccessInfoIndIdx = Com_GetRxAccessInfoIndStartIdxOfRxPduInfo(rxPduId);       /* PRQA S 2842 */ /* MD_Com_2842 */
    for(; com_RxAccessInfoIndIdx < Com_GetRxAccessInfoIndEndIdxOfRxPduInfo(rxPduId); com_RxAccessInfoIndIdx++)
    {
...
#  if ((COM_INITVALUEUSEDOFRXACCESSINFO == STD_ON) && (COM_BUFFERUSEDOFRXACCESSINFO == STD_ON))
      ...
      {
        Com_Signal_SetRxSigBufferValue(com_RxAccessInfoIdx, FALSE, Com_GetBufferIdxOfRxAccessInfo(com_RxAccessInfoIdx), TRUE, Com_GetInitValueIdxOfRxAccessInfo(com_RxAccessInfoIdx));
      }
#  endif
#  if ((COM_INITVALUEUSEDOFRXACCESSINFO == STD_ON) && (COM_MINPROCGWBUFFERUSEDOFRXACCESSINFO == STD_ON))
      if(Com_IsInitValueUsedOfRxAccessInfo(com_RxAccessInfoIdx) && Com_IsMinProcGwBufferUsedOfRxAccessInfo(com_RxAccessInfoIdx))        /* COV_COM_RXPROCESSING_TX */ /* PRQA S 2842 */ /* MD_Com_2842 */
      {
...
#  if ((COM_CONSTVALUEARRAYBASEDINITVALUEUSEDOFRXACCESSINFO == STD_ON) && (COM_MINPROCGWBUFFERARRAYBASEDBUFFERUSEDOFRXACCESSINFO == STD_ON))
      if(Com_IsConstValueArrayBasedInitValueUsedOfRxAccessInfo(com_RxAccessInfoIdx) && Com_IsMinProcGwBufferArrayBasedBufferUsedOfRxAccessInfo(com_RxAccessInfoIdx))    /* COV_COM_RXPROCESSING_TX */
      {
...
#   if ((COM_INITVALUEUSEDOFRXACCESSINFO == STD_ON) && (COM_SHDBUFFERUSEDOFRXACCESSINFO == STD_ON))
        ...
        {
          Com_Signal_SetRxSigBufferValue(com_RxAccessInfoIdx, TRUE, Com_GetShdBufferIdxOfRxAccessInfo(com_RxAccessInfoIdx), TRUE, Com_GetInitValueIdxOfRxAccessInfo(com_RxAccessInfoIdx));
        }
#   endif
...
# if(COM_ARRAYACCESSUSEDOFRXSIGGRPINFO == STD_ON)
  {
    ...
    Com_RxSigGrpInfoIndIterType com_SignalGroupIndId = Com_GetRxSigGrpInfoIndStartIdxOfRxPduInfo(rxPduId);      /* PRQA S 2842 */ /* MD_Com_2842 */
    for(; com_SignalGroupIndId < Com_GetRxSigGrpInfoIndEndIdxOfRxPduInfo(rxPduId); com_SignalGroupIndId++)      /* PRQA S 2842 */ /* MD_Com_2842 */
    {
...
# if (COM_EXISTS_DEFERRED_SIGNALPROCESSINGOFRXPDUINFO == STD_ON)
  ...
  if(Com_IsHandleRxPduDeferredUsedOfRxPduInfo(rxPduId)) /* PRQA S 2842 */ /* MD_Com_2842 */ /* COV_COM_FEATURE_ALWAYS_TRUE_TX */
  {
    Com_SetHandleRxPduDeferred(Com_GetHandleRxPduDeferredIdxOfRxPduInfo(rxPduId), 0);   /* PRQA S 2842 */ /* MD_Com_2842 */ /* SBSW_COM_CSL03 */

#  if (COM_GWEVENTCACHE == STD_ON)
    /* #40 If a gateway description exists, reset the gateway description handle */
    if(Com_IsGwTxPduDescriptionInfoUsedOfRxPduInfo(rxPduId) && Com_IsHandleRxDeferredGwDescriptionUsedOfRxPduInfo(rxPduId))    /* COV_COM_CSL03_ISUSED_OPTIONAL_INDIRECTION */
    {
      Com_SetHandleRxDeferredGwDescription(Com_GetHandleRxDeferredGwDescriptionIdxOfRxPduInfo(rxPduId), 0);     /* SBSW_COM_CSL03 */
    }
#  endif
  }
# endif
...
#if ((COM_RXIMMEDIATEFCTPTRCACHE == STD_ON) || (COM_RXDEFERREDFCTPTRCACHE  == STD_ON))
/**********************************************************************************************************************
 ...
 *
**********************************************************************************************************************/
FUNC(void, COM_CODE) Com_RxProcessing_RxPduSigEvent(Com_RxPduInfoIterType comRxPduInfoIdx, P2CONST(PduInfoType, AUTOMATIC, COM_APPL_DATA) PduInfoPtr, P2VAR(FctPtrCacheStrct, AUTOMATIC, COM_APPL_DATA) fctPtrCacheStrctPtr)    /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
{
  /* #10 Iterate over all Rx ComSignals of the passed Rx ComIPdu and do Rx ComSignal based processing */
  Com_RxSigInfoIterType idxRxSigInfo = Com_GetRxSigInfoStartIdxOfRxPduInfo(comRxPduInfoIdx);    /* PRQA S 2842 */ /* MD_Com_2842 */
 ...
 *
**********************************************************************************************************************/
FUNC(void, COM_CODE) Com_RxProcessing_RxPduSigGrpEvent(Com_RxPduInfoIterType comRxPduInfoIdx, P2CONST(PduInfoType, AUTOMATIC, COM_APPL_DATA) PduInfoPtr,
                                                       P2VAR(FctPtrCacheStrct, AUTOMATIC, COM_APPL_DATA) fctPtrCacheStrctPtr)
{
  /* #10 Iterate over all ComSignalGroups related to the passed ComIPdu and do ComSignalGroup based processing */
  Com_RxSigGrpInfoIterType idxRxSigGrpInfoInd = Com_GetRxSigGrpInfoIndStartIdxOfRxPduInfo(comRxPduInfoIdx);     /* PRQA S 2842 */ /* MD_Com_2842 */
 ...
 *
**********************************************************************************************************************/
FUNC(void, COM_CODE) Com_RxDeferredPduProcessing(Com_MainFunctionRxStructIterType mainFunctionId)
{
  Com_RxMainFunctionProcessingISRLockCounterIdxOfMainFunctionRxStructType rxMainFunctionProcessingISRLockCounteridx =
    Com_GetRxMainFunctionProcessingISRLockCounterIdxOfMainFunctionRxStruct(mainFunctionId);

# if (COM_RXDEFERREDEVENTCACHE == STD_ON)
  Com_RxNextEventCacheEntryIdxOfMainFunctionRxStructType nextEventCacheEntryIdx = Com_GetRxNextEventCacheEntryIdxOfMainFunctionRxStruct(mainFunctionId);
...
# if (COM_RXDEFERREDFCTPTRCACHE == STD_ON)
  deferredFctPtrCacheStrct.ptrToCache = Com_GetAddrRxDeferredFctPtrCache(Com_GetRxDeferredFctPtrCacheStartIdxOfMainFunctionRxStruct(mainFunctionId));
  deferredFctPtrCacheStrct.cacheSize = Com_GetRxDeferredFctPtrCacheLengthOfMainFunctionRxStruct(mainFunctionId);
# else
...
# if (COM_RXDEFERREDEVENTCACHE == STD_ON)
  ...
  if(Com_GetRxDeferredEventCacheIdxOfRxNextEventCacheEntry(nextEventCacheEntryIdx) != COM_NO_HANDLERXPDUDEFERREDIDXOFRXPDUINFO)
  {
    Com_RxPduInfoIterType idxRxPduInfo;
    fallbackRequired = FALSE;   /* Cache is not full. */

    /* #20 Iterate over all stored deferred events, and process them */
    while(Com_GetRxDeferredEventCacheIdxOfRxNextEventCacheEntry(nextEventCacheEntryIdx) > 0u)
    {
      Com_DecRxDeferredEventCacheIdxOfRxNextEventCacheEntry(nextEventCacheEntryIdx);    /* SBSW_COM_CSL_VAR_ACCESS */
      idxRxPduInfo = (Com_RxPduInfoIterType) Com_GetRxPduInfoIdxOfRxDeferredEventCache(Com_GetRxDeferredEventCacheIdxOfRxNextEventCacheEntry(nextEventCacheEntryIdx));
      if(idxRxPduInfo < Com_GetSizeOfRxPduInfo())       /* COV_COM_INDEX_IN_BOUNDS_CHECK */
      {
        if(Com_IsRxPduGrpActive(idxRxPduInfo))
        {
          if(0u < Com_GetHandleRxPduDeferred(Com_GetHandleRxPduDeferredIdxOfRxPduInfo(idxRxPduInfo)))
          {
            Com_RxProcessDeferredPDU(idxRxPduInfo, &deferredFctPtrCacheStrct);  /* SBSW_COM_FCTPTR_CACHE_PTR */
          }
        }
      }
      Com_RxProcessing_ThresholdCheck_Deferred(rxMainFunctionProcessingISRLockCounteridx, &deferredFctPtrCacheStrct);   /* SBSW_COM_FCTPTR_CACHE_PTR_1 */
      ...
      if(Com_GetRxDeferredEventCacheIdxOfRxNextEventCacheEntry(nextEventCacheEntryIdx) == COM_NO_HANDLERXPDUDEFERREDIDXOFRXPDUINFO)     /* COV_COM_DEFERRED_EVENTCACHE_FALLBACK */
      {
  ...
  {
    Com_RxDeferredPduProcessing_IterateOverAllRxPdus(mainFunctionId, &deferredFctPtrCacheStrct);        /* SBSW_COM_FCTPTR_CACHE_PTR_1 */
  }
  Com_RxProcessing_ExitExclusiveArea_Deferred(rxMainFunctionProcessingISRLockCounteridx);
# else
  {
    Com_RxProcessing_EnterExclusiveArea_Deferred();
    Com_RxDeferredPduProcessing_IterateOverAllRxPdus(mainFunctionId, &deferredFctPtrCacheStrct);        /* SBSW_COM_FCTPTR_CACHE_PTR_1 */
...
# if ((COM_RXTPINFOUSEDOFRXPDUINFO == STD_ON) && (COM_EXISTS_UINT8_DYN_APPLTYPEOFRXACCESSINFO == STD_ON))
    case COM_UINT8_DYN_APPLTYPEOFRXACCESSINFO:
    {
      if(Com_IsRxTpInfoUsedOfRxPduInfo(Com_GetRxPduInfoIdxOfRxAccessInfo(idxRxAccessInfo)))     /* COV_COM_CSL03_ISUSED_OPTIONAL_INDIRECTION */
      {
        Com_RxTpInfoIdxOfRxPduInfoType rxTpPduInfoIdx = Com_GetRxTpInfoIdxOfRxPduInfo(Com_GetRxPduInfoIdxOfRxAccessInfo(idxRxAccessInfo));
