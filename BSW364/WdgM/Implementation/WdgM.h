 ...
 *  05.02.01  2017-10-25  virchl  ESCAN00097188 Remove active MISRA deviations
 *                                              Generator fixes
 *  05.02.02  2018-04-10  virchl  STORYC-2913   Update WdgM documentation to AR4.2 (as already supported)
 *  05.02.03  2018-05-04  virchl  ESCAN00094612 WdgM_GetTickCount is called with suspended interrupts
 *  05.03.00  2018-04-17  virchl  STORYC-5033   Support application callbacks and status reporting for WdgM
 *                                STORYC-5087   The generated file names of WdgM no longer pretend that the component is
 *                                              PB-capable (static WdgM_Cfg.h renamend to WdgM_Types.h)
 *  05.04.00  2018-12-18  vircre  STORYC-5024   MISRA-C:2012 Compliance
 *  05.04.01  2019-04-18  vircre  ESCAN00102633 Wrong compiler abstraction: variable WdgMSupervisedEntity_pt should
 *                                              be const
 *  05.05.00  2019-07-17  vircre  MWDG-7        WdgM shall support at least 6 cores
 *  05.05.01  2019-09-19  virsrl  ESCAN00103969 Global variable g_wdgm_cfg_ptr is placed in different memory sections
 *                                              in definition and declaration
 *  05.05.02  2019-11-29  virsrl  ESCAN00104766 Compiler error: Types header incompatible with RTE
 *  05.05.03  2020-08-18  virbka  ESCAN00106860 WdgM: Incorrect deadline violation detection
 *  06.00.00  2020-11-26  virsrl  ESCAN00107716 WdgM: OsCounter overflow within deadline supervision
 *  06.00.01  2021-12-13  virsrl  MWDG-6227     WdgM: Correct main function CDD with regards to reentrancy
 *********************************************************************************************************************/
...
# define WDGM_AR_RELEASE_MINOR_VERSION            (2u)
# define WDGM_AR_RELEASE_REVISION_VERSION         (2u)

/* ----- Component version information (decimal version of ALM implementation package) ----- */
# define WDGM_SW_MAJOR_VERSION                    (6u)
# define WDGM_SW_MINOR_VERSION                    (0u)
# define WDGM_SW_PATCH_VERSION                    (1u)
...
# define WDGM_INTERNAL_CP_TEST_NOK       (0x0u)                                  /*!< Negative result for internal
                                                                                  *   failure
                                                                                  **/
# define WDGM_MAX_SUPPORTED_CORES        (10u)                                    /*!< Number of maximum supported
                                                                                  *   cores
                                                                                  */
...
#  define WDGM_DET_REPORTERROR(mod_id, core_or_inst_id, api_id, det_id) \
               (void)Det_ReportError(mod_id, core_or_inst_id, api_id, det_id)
# else
#  define WDGM_DET_REPORTERROR(mod_id, core_or_inst_id, api_id, det_id)
# endif
...
extern CONSTP2CONST(WdgM_SupervisedEntityType, WDGM_CONST, WDGM_APPL_CONST) WdgMSupervisedEntity_pt;
 ...
 */
extern P2CONST(WdgM_ConfigType, WDGM_VAR_ZERO_INIT, WDGM_APPL_CONST) g_wdgm_cfg_ptr;
 ...
 *  \context      TASK
 *  \reentrant    TRUE; with regards to be safely invokable from multiple cores
 *  \synchronous  TRUE
 ...
 */
/* PRQA S 3449 1 */ /* MD_WdgM_3449_3451 */
 ...
 *                WdgMTriggerConditionValue, WdgMWatchdogMode
 *  \trace        DSGN-WdgM22781
 ...
 *  \trace        DSGN-WdgM22780
 */
/* PRQA S 3449, 3451 1 */ /* MD_WdgM_3449_3451 */
 ...
 *  \pre          If the timebase tick counter source is the WDGM_OS_COUNTER_TICK, the function must not be called
 ...
 *********************************************************************************************************************/
/*!
 * \brief           Calculates time ticks difference
 * \details         Takes wrap around into account.
 * \param[in]       current_ticks   Current time ticks.
 * \param[in]       prev_ticks      Previous time ticks.
 * \param[in]       wdgm_cfg_ptr    Current configuration pointer.
