...
/*!
  ...
  \{
*/
# define IPDUM_SW_MAJOR_VERSION       11u
...
# define IPDUM_LOCAL_INLINE LOCAL_INLINE
#endif
/**********************************************************************************************************************
  GLOBAL FUNCTION MACROS
**********************************************************************************************************************/
#if (IPDUM_DEV_ERROR_REPORT == STD_ON)
# define IpduM_Det_ReportError(ApiId, ErrorCode)        (void) Det_ReportError(IPDUM_MODULE_ID, 0U, (ApiId), (ErrorCode))   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
# define IpduM_Det_ReportRuntimeError(ApiId, ErrorCode) (void) Det_ReportRuntimeError(IPDUM_MODULE_ID, 0U, (ApiId), (ErrorCode))
#else
# define IpduM_Det_ReportError(ApiId, ErrorCode)
# define IpduM_Det_ReportRuntimeError(ApiId, ErrorCode)
#endif
...
extern P2CONST(IpduM_ConfigType, IPDUM_VAR_CLEARED, IPDUM_INIT_DATA) IpduM_ConfigDataPtr;
#endif
