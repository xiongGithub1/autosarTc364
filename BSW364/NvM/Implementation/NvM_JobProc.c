...
CONST(NvM_IntServiceDescrType, NVM_PRIVATE_CONST) NvM_IntServiceDescrTable_at[(uint32)NVM_INT_FID_NO_JOB_PENDING + 1u] =
{
    ...
    {
        NVM_ACT_ID_InitWriteBlock, NVM_STATE_WRITE_COPY_BUFFER_DATA, NVM_WRITE_BLOCK
    },
 ...
 *********************************************************************************************************************/
    /* NVM_STATE_WRITE_COPY_BUFFER_DATA = initial state of Write Block */
    {
        ...
        {   /* No encryption nor DataIntegrity algorithm configured -> go on with processing */
            NVM_STATE_ELSE{NVM_ACT_ID_Nop, NVM_ACT_ID_Nop},
            NVM_NEXT_STATE(NVM_STATE_WRITE_CHECK_CRCCOMPARE_SKIP)
        }
    },
    ...
    {
        {
            ...
            {   /* Native or Dataset block, CRCCompareMechanism configured and matching => skip unnecessary write */
                NVM_STATE_ELSEIF{NvM_QRY_ID_CRC_COMP_MECHANISM_SKIPWRITE, NVM_QRY_ID_TRUE},
                    NVM_STATE_THEN{NVM_ACT_ID_FinishWriteBlock, NVM_ACT_ID_Nop},
                    NVM_NEXT_STATE(NVM_STATE_FSM_FINISHED)
            },
            {   /* Native or Dataset block, no CRCCompareMechanism configured or not matching*/
                NVM_STATE_ELSEIF{NVM_QRY_ID_TRUE, NVM_QRY_ID_TRUE},
    ...
    {
        {
            ...
            {   /* Both blocks readable, CRC matches -> no write, finalize job */
                NVM_STATE_ELSEIF{NVM_QRY_ID_LAST_RESULT_OK, NvM_QRY_ID_CRC_COMP_MECHANISM_SKIPWRITE},
                   NVM_STATE_THEN{NVM_ACT_ID_FinishWriteBlock, NVM_ACT_ID_Nop},
                   NVM_NEXT_STATE(NVM_STATE_FSM_FINISHED)
            },
    ...
    {
        {
            ...
            {   /* Explicit sync failed => no CRCCompare check, go on FSM processing */
