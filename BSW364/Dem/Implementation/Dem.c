...
/* module specific MISRA deviations:
   ...
   MD_DEM_8.5_declarationInMultipleFiles:
     ...
     Reason:      Some MICROSAR modules generate prototypes of Dem APIs. This leads to duplicate declarations in seperate files.
...
\ID SBSW_DEM_WRITE_PIDF501_BUFFER
  \DESCRIPTION    An uint8 value is written to a PIDF501 data block array, which is checked to be greated than DEM_READINESS_PIDF501_SIZE in 
...
\ID SBSW_DEM_ARRAY_WRITE_MONITORACTIVITYNUMERATOR
  \DESCRIPTION    In a function, data is wirtten to array Dem_Cfg_ObdIumprData.MonitorActivityNumerator[] using a function argument as index.
...
\CM CM_DEM_S_TIMESERIESINDEX_TYPE
  ...
  Verify that in table _Dem_Cfg_MemoryInfoTable_, in the row indicated by preprocessor macro _DEM_CFG_MEMORYID_TIMESERIES_, 
  the member _FirstMemoryIndexOfMemoryInfoTable_ is equal to DEM_CFG_MEMORY_TIME_SERIES_INDEX and the member
  the member _MaxSizeOfMemoryInfoTable_ is equal to DEM_CFG_GLOBAL_TIMESERIES_SNAPSHOTS_SIZE.

  The table _Dem_Cfg_MemoryDataPtr[]_, _Dem_Cfg_MemoryInfoTable[]_ are generated into _Dem_Lcfg.c_.
  The type _Dem_Cfg_TimeSeriesEntryType_ is generated into _Dem_Lcfg.h_.
  The preprocessor macro _DEM_CFG_MEMORYID_TIMESERIES_ is generated into _Dem_Lcfg.h_.
