...
#define DEM_CFG_READINESS_NOXADSORB             (19U)  /*!< OBD readiness group DEM_OBD_RDY_DEM_OBD_RDY_NOXADSORB */
...
#define DEM_CFG_READINESS_GROUP_SIZE            (25U)  /*!< first invalid OBD readiness group */
