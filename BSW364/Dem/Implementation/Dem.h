 ...
 *            2021-04-21  visrk        DEM-4738      Provide DTR data per DTC as extdended data record
...
#define DEM_SW_MAJOR_VERSION                     (22U)
...
#define DEM_DTC_GROUP_WWHOBD_DTCS                ((Dem_DTCGroupType)(0x00ffff33UL))  /*< predefined DTC group encoding 'Emmission related DTCs' for WWH-OBD (legacy, must have the same value as DEM_DTC_GROUP_OBD_DTCS) */
#define DEM_DTC_GROUP_OBD_DTCS                   ((Dem_DTCGroupType)(0x00ffff33UL))  /*< predefined DTC group encoding 'Emmission related DTCs' for WWH-OBD and OBD on UDS */
