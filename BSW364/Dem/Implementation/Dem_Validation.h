...
#if (DEM_CFG_SUPPORT_J1939 == STD_ON) && (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS != STD_ON) && (DEM_CFG_STORAGE_AT_CONFIRMED != STD_ON)
# error "DEM_CFG_SUPPORT_J1939 == STD_ON && DEM_CFG_STORAGE_AT_CONFIRMED != STD_ON is not supported"
#endif

#if (DEM_CFG_SUPPORT_OBDII_OR_OBDONUDS == STD_ON) && (DEM_CFG_STORAGE_AT_FAILED != STD_ON)
# error "OBDII / OBDonUDS requires Storage Trigger Failed"
#endif
