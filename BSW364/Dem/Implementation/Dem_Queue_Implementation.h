  ...
  )
{
  ...
  if (Dem_ActivationMode_GetQualifiedActiveEventCount(DEM_ESM_WWHOBD_DTCCLASS_B1) != 0u)
  {
  ...
  )
{
  ...
  if (Dem_ActivationMode_GlobalIndicatorActivationMode() == DEM_INDICATOR_CONTINUOUS)
  {
