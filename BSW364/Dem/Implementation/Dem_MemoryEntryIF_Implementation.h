 ...
 */
DEM_LOCAL_INLINE FUNC(uint8, DEM_CODE)
Dem_MemoryEntry_MemoryEntryIF_GetSnapshotHeaderFifo(                                                                                           /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_Cfg_MemoryEntryHandleType  MemoryEntryId
)
{
  uint8 lSnapshotHeaderFifo;
#if (DEM_CFG_SUPPORT_SRECS == STD_ON)
  lSnapshotHeaderFifo = Dem_MemoryEntry_GetEntry(MemoryEntryId)->SnapshotHeaderFifo;
#else
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(MemoryEntryId)                                                                                /* PRQA S 3112 */ /* MD_DEM_14.2 */
  Dem_Internal_AssertAlways(DEM_E_INCONSISTENT_STATE);
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_MemoryEntry_MemoryEntryIF_SetSnapshotHeaderFifo(                                                                                           /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  Dem_Cfg_MemoryEntryHandleType  MemoryEntryId,
  uint8  SnapshotHeaderFifo
)
{
#if (DEM_CFG_SUPPORT_SRECS == STD_ON)
  Dem_MemoryEntry_GetEntry(MemoryEntryId)->SnapshotHeaderFifo = SnapshotHeaderFifo;                                              /* SBSW_DEM_POINTER_WRITE_MEMORYENTRY */
#else
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(MemoryEntryId)                                                                                /* PRQA S 3112 */ /* MD_DEM_14.2 */
...
{
  return (boolean)(Dem_MemoryEntry_GetEventId(Dem_MemoryEntry_GetId(Index)) == EventId);
}
  ...
  )
{
  ...
  lMemoryEntryId = Dem_MemoryEntry_GetId(Index);
...
# endif
  Dem_MemoryEntry_MemoryEntryIF_SetSnapshotHeaderFifo(MemoryEntryId, 0U);
#endif
  ...
  )
{
  ...
  lReturnValue = Dem_Cfg_GetMemoryBlockIdToMemoryEntryId(BlockIndex);                                                            /* PRQA S 2841 */ /* MD_DEM_Dir4.1_ReadOperation */
