...
{
  return Dem_Error_DetectionHandler(Dem_FaultMemory_Memory_TestDTCOriginValid(DTCOrigin));
}
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_APIChecks_IsDTCFormatUDS(                                                                                     /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  Dem_DTCFormatType  DTCFormat
)
{
...
{
  return Dem_Error_DetectionHandler(StorageConditionID < Dem_Conditions_StorageCondition_GetGlobalCount());
}
...
)
{
  return Dem_Error_DetectionHandler((EnableConditionID != DEM_ENABLECONDITION_CONTROLDTCSETTING)
    && (EnableConditionID < Dem_Conditions_EnableCondition_GetGlobalEnableConditionCount()));
}
