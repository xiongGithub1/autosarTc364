 ...
 *****************************************************************************/
/*!
 * \brief         Test if clearing of all WWH-OBD or OBD on UDS related DTCs is allowed.
 *
 * \details       Test if clearing of all WWH-OBD or OBD on UDS related DTCs is allowed.
 *
 * \return        TRUE
  ...
  )
{
  ...
  if ( (Dem_Cfg_IsWwhObdSupportedInVariant() == TRUE) || (Dem_Cfg_IsObdOnUdsSupportedInVariant() == TRUE) )
  {
    lReturnValue = TRUE;
  }
  else
 ...
 *                  - All WWH-OBD or OBD on UDS DTCs.
