...
extern VAR(boolean, XCP_VAR_NOINIT)  XcpAppl_MeasurementStart;
 ...
 *  XcpAppl_InitMemory()
 *********************************************************************************************************************/
/*! \brief       Initializes the template in case no start up code is used.
 *  \details     -
 *  \context     TASK|ISR2
 *  \reentrant   TRUE
 *  \synchronous TRUE
 ...
 *  XcpAppl_Init()
 *********************************************************************************************************************/
/*! \brief       Initializes the template.
 *  \details     -
 *  \context     TASK|ISR2
 *  \reentrant   TRUE
 *  \synchronous TRUE
...
#  if defined ( XcpAppl_CheckProgramAccess ) /* defined as macro */ /* COV_XCP_MSR_COMPATIBILITY */
#  else
/**********************************************************************************************************************
 ...
 *********************************************************************************************************************/
/*! \brief       Gets the total length of the Seed.
 *  \details     Attention: The seed has a maximum length of 255 bytes.
 ...
 *  \ingroup     xcpappl
 *********************************************************************************************************************/
extern FUNC(uint8, XCP_CODE)              XcpAppl_GetSeedLength( const uint8 Resource );
 ...
 *  \details     Attention: The seed has a maximum length of 255 bytes.
 *  \param[in]   Resource          resource (either XCP_RM_CAL_PAG or XCP_RM_DAQ or XCP_RM_STIM or XCP_RM_PGM)
 *  \param[in]   Position          The position the seed fragment shall be read from.
 *  \param[in]   Length            The length of the seed fragment that shall be read.
 ...
 *  \ingroup     xcpappl
 *********************************************************************************************************************/
extern FUNC(void, XCP_CODE)              XcpAppl_GetSeed( const uint8 Resource,
 ...
 *********************************************************************************************************************/
/*! \brief       Assembles a fragmented Key received via XCP.
 *  \details     The function needs to copy the selected fragment to assemble a complete key.
 *  \param[in]   Key               Pointer to the key.
 *  \param[in]   Position          Index to write the key to.
 ...
 *  \ingroup     xcpappl
 *********************************************************************************************************************/
FUNC(void, XCP_CODE)                     XcpAppl_UnlockWriteKey( P2CONST(uint8, AUTOMATIC, XCP_APPL_DATA) Key,
                                                                 const uint8 Position,
                                                                 const uint8 Length );
 ...
 *  \ingroup     xcpappl
 *********************************************************************************************************************/
extern FUNC(uint8, XCP_CODE)              XcpAppl_Unlock( void );
# endif
 ...
 *  \param[out]  CalPage           The returned active CalPage.
 *  \return      XCP_CMD_OK        CalPage could be determined.
 *  \return      XCP_CMD_OUT_OF_RANGE Input parameters invalid.
 *  \context     TASK|ISR2
 *  \reentrant   FALSE
 *  \synchronous TRUE
 *  \config      Available only if XCP_CALIBRATION_PAGE == STD_ON.
...
extern FUNC(uint8, XCP_CODE)              XcpAppl_GetCalPage( uint8 Segment, uint8 Mode,
                                                              P2VAR(uint8, AUTOMATIC, XCP_APPL_DATA) CalPage );
# endif
 ...
 *  \reentrant   FALSE
 *  \synchronous FALSE (depending on application behavior)
 *  \config      Available only if XCP_PROGRAM == STD_ON and XCP_BOOTLOADER_DOWNLOAD == STD_OFF.
 *  \pre         -
 *  \ingroup     xcpappl
 *  \trace       CREQ-117297
 *********************************************************************************************************************/
 ...
 *  \param[in]   Address           Pointer to memory address
 *  \param[in]   Size              Memory size.
 *  \param[in]   BlockRemainder    Remaining data until block can safely be programmed in block mode.
 ...
 *  \trace       CREQ-117296
 *********************************************************************************************************************/
extern FUNC(boolean, XCP_CODE) XcpAppl_DaqResume( Xcp_ChannelType XcpChannel,
 ...
 *  XcpAppl_DaqCleanup()
 *********************************************************************************************************************/
/*! \brief       Clean up complementary memory of the specified channel.
 *  \details     -
 *  \param[in]   XcpChannel        Related XCP channel.
 *  \context     TASK|ISR2
 *  \reentrant   FALSE
 ...
 *  \ingroup     xcpappl
 *********************************************************************************************************************/
extern FUNC(void, XCP_CODE) XcpAppl_DaqCleanup(Xcp_ChannelType XcpChannel);

/**********************************************************************************************************************
 *  XcpAppl_GetSendQueueRef()
 *********************************************************************************************************************/
/*! \brief       Get a reference to the send buffer.
 *  \details     This application callback service is used to get the send buffer for transmission of the content
 *               of the requested event channel.
 *  \param[in]   XcpChannel        Related XCP channel.
 *  \param[in]   EventIndex        Related Event channel.
 *  \param[out]  SendQueuePtr      A pointer to the send buffer.
 *  \context     TASK|ISR2
 *  \reentrant   FALSE
 *  \synchronous TRUE
 *  \config      Available only if XCP_DAQ == STD_ON and XCP_DAQ_COMPLEMENTARY_CHANNEL == STD_ON.
 ...
 *  \ingroup     xcpappl
 *********************************************************************************************************************/
extern FUNC(void, XCP_CODE) XcpAppl_GetSendQueueRef(Xcp_ChannelType XcpChannel, uint16 EventIndex,
                                                    P2VAR(uint8*, AUTOMATIC, XCP_APPL_DATA) SendQueuePtr);

/**********************************************************************************************************************
 *  XcpAppl_TransmitSendQueueElement()
 *********************************************************************************************************************/
/*! \brief       Transmits the current Event Channel elements.
 *  \details     This application callback service is used to trigger transmission of the currently assembled DAQ lists
 *               of the requested event channel.
 *  \param[in]   XcpChannel        Related XCP channel.
 *  \param[in]   EventIndex        Related Event channel.
 *  \context     TASK|ISR2
 ...
 *  \ingroup     xcpappl
 *********************************************************************************************************************/
extern FUNC(void, XCP_CODE) XcpAppl_TransmitSendQueueElement(Xcp_ChannelType XcpChannel, uint16 EventIndex);

/**********************************************************************************************************************
 *  XcpAppl_DaqPrepare()
 *********************************************************************************************************************/
/*! \brief       Prepares transmission by allocating transmit buffer.
 *  \details     This application callback service is used to allocate the transmit buffers. For this the DAQ lists
 *               have to be parsed and the size determined.
 *  \param[in]   XcpChannel        Related XCP channel.
 *  \context     TASK|ISR2
 *  \reentrant   FALSE
 *  \synchronous TRUE
 ...
 *  \ingroup     xcpappl
 *********************************************************************************************************************/
extern FUNC(uint8, XCP_CODE) XcpAppl_DaqPrepare(Xcp_ChannelType XcpChannel);
